...
from CharacterContent.Classes.SubClasses2024.RangerFeyWanderer import (
    RangerFeyWandererLevel3,
...
class Y2024RangerFeyWandererAlderMistwalkerCharacterBuilder(CharacterBuilder):
    def __init__(self):
        super().__init__(
            name="Alder Mistwalker",
