"""Example build: Sorcerer Lunar Sorcery (2014 rules). Demonstrates a moon-touched sorcerer with cleric/wizard spell access."""
...
from CharacterContent.Classes.SubClasses2014.SorcererLunarSorcery import (
    SorcererLunarSorceryCustomStarterClassArgs,
    SorcererLunarSorceryLevel3,
    SorcererLunarSorceryLevel5,
    SorcererLunarSorceryLevel6,
    SorcererLunarSorceryLevel7,
    SorcererLunarSorceryLevel9,
    SorcererLunarSorceryLevel14,
    SorcererLunarSorceryLevel18,
)
...
def get_starter_class_builder():
    return StarterClassBuilder(
        non_generic_arguments=SorcererLunarSorceryCustomStarterClassArgs(
        ...
        base_class_level_features=ClassBuilder.BaseClassLevelFeatures(
            base_class_features_by_level={
                1: SorcererLevel1(
                    ...
                    spell_1=SpellDefinitions.SorcererLevel1Spells.MAGIC_MISSILE,
                ...
                14: SorcererLevel14(),
                15: SorcererLevel15(
                    spell=SpellDefinitions.SorcererLevel5Spells.WALL_OF_STONE,
                ),
                16: SorcererLevel16(
                    general_feat=GeneralFeats.AbilityScoreImprovement(
            ...
            subclass_features_by_level={
                3: SorcererLunarSorceryLevel3(),
                5: SorcererLunarSorceryLevel5(),
                6: SorcererLunarSorceryLevel6(),
                7: SorcererLunarSorceryLevel7(),
                9: SorcererLunarSorceryLevel9(),
                14: SorcererLunarSorceryLevel14(),
                18: SorcererLunarSorceryLevel18(),
            },
        ),
    )


class ExampleSorcererLunarSorcery2014CharacterBuilder(CharacterBuilder):
    def __init__(self):
        super().__init__(
            name="Example Lunar Sorcery Sorcerer",
