...
from CharacterContent.Classes.SubClasses2014.ClericDeath import (
...
class Y2014ClericDeathMortimerGrimvaleCharacterBuilder(CharacterBuilder):
    def __init__(self):
        super().__init__(
            name="Mortimer Grimvale",
