"""Example build: Fighter Cavalier (2014 rules)."""
...
from CharacterContent.Classes.SubClasses2014.FighterCavalier import (
    FighterCavalierCustomStarterClassArgs,
    FighterCavalierLevel3,
    FighterCavalierLevel7,
    FighterCavalierLevel10,
    FighterCavalierLevel15,
...
def get_starter_class_builder():
    return StarterClassBuilder(
        non_generic_arguments=FighterCavalierCustomStarterClassArgs(
        ...
        base_class_level_features=BaseClassLevelFeatures(
            base_class_features_by_level={
                1: FighterLevel1(
                    weapon_mastery_1=Weapons.Lance(),
            ...
            subclass_features_by_level={
                3: FighterCavalierLevel3(),
                7: FighterCavalierLevel7(),
                10: FighterCavalierLevel10(),
                15: FighterCavalierLevel15(),
                18: FighterCavalierLevel18(),
            },
        ),
    )


class Y2014FighterCavalierPercivalSteelmountCharacterBuilder(CharacterBuilder):
    def __init__(self):
        super().__init__(
            name="Percival Steelmount",
