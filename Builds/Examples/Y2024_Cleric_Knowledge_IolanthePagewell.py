"""Example build: Cleric Knowledge Domain. Adapted from an optimized reference build to demonstrate this subclass."""
...
class Y2024ClericKnowledgeIolanthePagewellCharacterBuilder(CharacterBuilder):
    def __init__(self):
        super().__init__(
            name="Iolanthe Pagewell",
