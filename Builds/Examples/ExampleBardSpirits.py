...
from CharacterConfigs.SubClasses.BardSpirits import (
    BardSpiritsLevel3,
    BardSpiritsLevel6,
    BardSpiritsLevel14,
    ...
    return StarterClassBuilder(
        ...
        base_class_level_features=ClassBuilder.BaseClassLevelFeatures(
            base_class_features_by_level={
                ...
                3: BardLevel3(
                    spell=BardLevel2Spells.SILENCE,
                ),
                4: BardLevel4(
                ...
                9: BardLevel9(
                    spell_1=BardLevel5Spells.GEAS,
                    spell_2=BardLevel5Spells.MASS_CURE_WOUNDS,
            ...
            subclass_features_by_level={
                3: BardSpiritsLevel3(),
                6: BardSpiritsLevel6(),
                14: BardSpiritsLevel14(),
            },
        ),
        replace_spells={
            # Replace the default spell choices with better ones
            BardLevel1Spells.BANE: BardLevel2Spells.ENHANCE_ABILITY,
        },
    )


class ExampleBardSpiritsCharacterBuilder(CharacterBuilder.CharacterBuilder):
    def __init__(self):
        super().__init__(
            name="Example Spirits Bard",
