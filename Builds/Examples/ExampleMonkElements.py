"""Example build: Monk Warrior of the Elements. Adapted from an optimized reference build to demonstrate this subclass."""
...
from CharacterConfigs.SubClasses.MonkElements import (
    MonkElementsLevel3,
    MonkElementsLevel6,
    MonkElementsLevel11,
    MonkElementsLevel17,
    ...
    return StarterClassBuilder(
        ...
        base_class_level_features=ClassBuilder.BaseClassLevelFeatures(
            ...
            subclass_features_by_level={
                ...
                6: MonkElementsLevel6(),
                11: MonkElementsLevel11(),
                17: MonkElementsLevel17(),
            },
        ),
    )


class ExampleMonkElementsCharacterBuilder(CharacterBuilder):
    def __init__(self):
        super().__init__(
            name="Example Elements Monk",
