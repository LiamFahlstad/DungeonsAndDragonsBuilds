"""Example build: Warlock The Celestial Patron (2014 rules). Demonstrates the subclass up through level 14."""
...
from CharacterContent.Classes.SubClasses2014.WarlockTheCelestial import (
    WarlockTheCelestialLevel3,
    WarlockTheCelestialLevel6,
    WarlockTheCelestialLevel10,
    WarlockTheCelestialLevel14,
    WarlockTheCelestialCustomStarterClassArgs,
)
...
def get_starter_class_builder():
    return StarterClassBuilder(
        non_generic_arguments=WarlockTheCelestialCustomStarterClassArgs(
        ...
        base_class_level_features=ClassBuilder.BaseClassLevelFeatures(
            ...
            subclass_features_by_level={
                3: WarlockTheCelestialLevel3(),
                6: WarlockTheCelestialLevel6(),
                10: WarlockTheCelestialLevel10(),
                14: WarlockTheCelestialLevel14(),
            },
        ),
        replace_spells={},
    )
...
class ExampleWarlockTheCelestial2014CharacterBuilder(CharacterBuilder):
    def __init__(self):
        super().__init__(
            name="Example Warlock The Celestial",
