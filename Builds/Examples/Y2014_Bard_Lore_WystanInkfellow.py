...
from CharacterContent.ToolProficiencies.Proficiencies import Dulcimer, Flute, Lute
...
class Y2014BardLoreWystanInkfellowCharacterBuilder(CharacterBuilder):
    def __init__(self):
        super().__init__(
            name="Wystan Inkfellow",
