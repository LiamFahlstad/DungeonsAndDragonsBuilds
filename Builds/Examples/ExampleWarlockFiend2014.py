"""Example build: Warlock The Fiend Patron (2014 rules). Demonstrates the subclass up through level 14."""
...
from CharacterContent.Classes.SubClasses2014.WarlockFiend import (
    WarlockFiendLevel3,
    WarlockFiendLevel6,
    WarlockFiendLevel10,
    WarlockFiendLevel14,
    WarlockFiendCustomStarterClassArgs,
)
...
def get_starter_class_builder():
    return StarterClassBuilder(
        non_generic_arguments=WarlockFiendCustomStarterClassArgs(
        ...
        base_class_level_features=ClassBuilder.BaseClassLevelFeatures(
            ...
            subclass_features_by_level={
                3: WarlockFiendLevel3(),
                6: WarlockFiendLevel6(),
                10: WarlockFiendLevel10(),
                14: WarlockFiendLevel14(),
            },
        ),
        replace_spells={},
    )
...
class ExampleWarlockFiend2014CharacterBuilder(CharacterBuilder):
    def __init__(self):
        super().__init__(
            name="Example Warlock The Fiend",
