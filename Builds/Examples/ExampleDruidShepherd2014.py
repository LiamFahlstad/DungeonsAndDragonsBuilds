"""Example build: Druid Circle of the Shepherd (2014 rules). Demonstrates the subclass up through level 14."""
...
from CharacterContent.Classes.SubClasses2014.DruidCircleOfTheShepherd import (
    DruidShepherdCustomStarterClassArgs,
    DruidShepherdLevel3,
    DruidShepherdLevel6,
    DruidShepherdLevel10,
    DruidShepherdLevel14,
)
...
def get_starter_class_builder():
    return StarterClassBuilder(
        non_generic_arguments=DruidShepherdCustomStarterClassArgs(
        ...
        base_class_level_features=ClassBuilder.BaseClassLevelFeatures(
            base_class_features_by_level={
                ...
                3: DruidLevel3(
                    spell=DruidLevel2Spells.ANIMAL_MESSENGER,
                ),
                4: DruidLevel4(
                    ...
                    spell=DruidLevel2Spells.BARKSKIN,
                ),
                5: DruidLevel5(
                    spell_1=DruidLevel3Spells.CONJURE_ANIMALS,
                    spell_2=DruidLevel3Spells.PLANT_GROWTH,
                ),
                6: DruidLevel6(
                    spell=DruidLevel3Spells.SPEAK_WITH_PLANTS,
                ),
                7: DruidLevel7(
                ...
                10: DruidLevel10(
                    ...
                    spell=DruidLevel4Spells.CONJURE_WOODLAND_BEINGS,
                ),
                11: DruidLevel11(
            ...
            subclass_features_by_level={
                3: DruidShepherdLevel3(),
                6: DruidShepherdLevel6(),
                10: DruidShepherdLevel10(),
                14: DruidShepherdLevel14(),
            },
        ),
        replace_spells={},
    )
...
class ExampleDruidShepherd2014CharacterBuilder(CharacterBuilder):
    def __init__(self):
        super().__init__(
            name="Example Circle of the Shepherd Druid",
