"""Example build: Bard College of Eloquence (2014 rules). Demonstrates the subclass up through level 14."""
...
from CharacterContent.Classes.SubClasses2014.BardEloquence import (
    BardEloquenceCustomStarterClassArgs,
    BardEloquenceLevel3,
    BardEloquenceLevel6,
...
from CharacterContent.ToolProficiencies.Proficiencies import Horn, Lute, Lyre
from StatBlocks.SkillsStatBlock import BardSkillsStatBlock


def get_starter_class_builder():
    return StarterClassBuilder(
        non_generic_arguments=BardEloquenceCustomStarterClassArgs(
        ...
        base_class_level_features=ClassBuilder.BaseClassLevelFeatures(
            ...
            subclass_features_by_level={
                3: BardEloquenceLevel3(),
                6: BardEloquenceLevel6(),
                14: BardEloquenceLevel14(),
            },
        ),
    )


class Y2014BardEloquenceCorvinusTalebrightCharacterBuilder(CharacterBuilder):
    def __init__(self):
        super().__init__(
            name="Corvinus Talebright",
