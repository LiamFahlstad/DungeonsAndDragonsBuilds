"""Example build: Warlock The Fathomless Patron (2014 rules). Demonstrates the subclass up through level 14."""
...
from CharacterContent.Classes.SubClasses2014.WarlockFathomless import (
    WarlockFathomlessLevel3,
    WarlockFathomlessLevel6,
    WarlockFathomlessLevel10,
    WarlockFathomlessLevel14,
    WarlockFathomlessCustomStarterClassArgs,
)
    ...
    return StarterClassBuilder(
        ...
        base_class_level_features=ClassBuilder.BaseClassLevelFeatures(
            ...
            subclass_features_by_level={
                3: WarlockFathomlessLevel3(),
                6: WarlockFathomlessLevel6(),
                10: WarlockFathomlessLevel10(),
                14: WarlockFathomlessLevel14(),
            },
        ),
        replace_spells={},
    )
...
class ExampleWarlockFathomless2014CharacterBuilder(CharacterBuilder):
    def __init__(self):
        super().__init__(
            name="Example Warlock The Fathomless",
