"""Example build: Artificer Battle Smith. Adapted from an optimized reference build to demonstrate this subclass."""
...
class Y2024ArtificerBattleSmithJuniaCoglanceCharacterBuilder(CharacterBuilder):
    def __init__(self):
        super().__init__(
            name="Junia Coglance",
