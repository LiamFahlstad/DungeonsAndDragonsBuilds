...
def get_starter_class_builder():
    return StarterClassBuilder(
        non_generic_arguments=WizardDivinerCustomStarterClassArgs(
...
class Y2024WizardDivinationElowenFatereaderCharacterBuilder(CharacterBuilder):
    def __init__(self):
        super().__init__(
            name="Elowen Fatereader",
