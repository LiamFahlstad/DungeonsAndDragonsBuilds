"""Example build: Ranger Monster Slayer (2014 rules). Demonstrates the subclass up through level 17."""
...
from CharacterContent.Classes.SubClasses2014.RangerMonsterSlayer import (
    RangerMonsterSlayerLevel3,
    RangerMonsterSlayerLevel5,
    RangerMonsterSlayerLevel7,
    RangerMonsterSlayerLevel9,
    RangerMonsterSlayerLevel11,
    RangerMonsterSlayerLevel13,
    RangerMonsterSlayerLevel15,
    RangerMonsterSlayerLevel17,
    RangerMonsterSlayerCustomStarterClassArgs,
)
...
from CharacterContent.Spells.SpellLists import RangerLevel1Spells, RangerLevel2Spells, RangerLevel3Spells, RangerLevel4Spells, RangerLevel5Spells
...
def get_starter_class_builder():
    return StarterClassBuilder(
        non_generic_arguments=RangerMonsterSlayerCustomStarterClassArgs(
        ...
        base_class_level_features=ClassBuilder.BaseClassLevelFeatures(
            ...
            subclass_features_by_level={
                3: RangerMonsterSlayerLevel3(),
                5: RangerMonsterSlayerLevel5(),
                7: RangerMonsterSlayerLevel7(),
                9: RangerMonsterSlayerLevel9(),
                11: RangerMonsterSlayerLevel11(),
                13: RangerMonsterSlayerLevel13(),
                15: RangerMonsterSlayerLevel15(),
                17: RangerMonsterSlayerLevel17(),
            },
        ),
        replace_spells={},
    )
...
class ExampleRangerMonsterSlayer2014CharacterBuilder(CharacterBuilder):
    def __init__(self):
        super().__init__(
            name="Example Ranger Monster Slayer",
