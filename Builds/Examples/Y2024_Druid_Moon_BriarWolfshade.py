"""Example build: Druid Circle of the Moon. Adapted from an optimized reference build to demonstrate this subclass."""
...
class Y2024DruidMoonBriarWolfshadeCharacterBuilder(CharacterBuilder):
    def __init__(self):
        super().__init__(
            name="Briar Wolfshade",
