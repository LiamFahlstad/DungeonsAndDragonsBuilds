...
from CharacterContent.Classes.SubClasses2014.ArtificerArtillerist import (
...
class Y2014ArtificerArtilleristOskarBoltwrightCharacterBuilder(CharacterBuilder):
    def __init__(self):
        super().__init__(
            name="Oskar Boltwright",
