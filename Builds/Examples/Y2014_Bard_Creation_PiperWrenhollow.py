"""Example build: Bard College of Creation (2014 rules). Demonstrates the subclass up through level 14."""
...
from CharacterContent.Classes.SubClasses2014.BardCreation import (
    BardCreationCustomStarterClassArgs,
    BardCreationLevel3,
    BardCreationLevel6,
    BardCreationLevel14,
)
...
def get_starter_class_builder():
    return StarterClassBuilder(
        non_generic_arguments=BardCreationCustomStarterClassArgs(
        ...
        base_class_level_features=ClassBuilder.BaseClassLevelFeatures(
            ...
            subclass_features_by_level={
                3: BardCreationLevel3(),
                6: BardCreationLevel6(),
                14: BardCreationLevel14(),
            },
        ),
    )


class Y2014BardCreationPiperWrenhollowCharacterBuilder(CharacterBuilder):
    def __init__(self):
        super().__init__(
            name="Piper Wrenhollow",
