"""Example build: Barbarian Path of the Berserker. Adapted from an optimized reference build to demonstrate this subclass."""
...
from CharacterContent.Classes.SubClasses2024.BarbarianPathOfTheBerserker import (
...
class Y2024BarbarianBerserkerRurikBloodfangCharacterBuilder(CharacterBuilder):
    def __init__(self):
        super().__init__(
            name="Rurik Bloodfang",
