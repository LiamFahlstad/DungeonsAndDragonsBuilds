"""Example build: Barbarian Path of the Storm Herald (2014 rules). Chooses the Sea environment."""
...
from CharacterContent.Classes.SubClasses2014.BarbarianPathOfTheStormHerald import (
    BarbarianStormHeraldCustomStarterClassArgs,
    BarbarianStormHeraldLevel3,
    BarbarianStormHeraldLevel6,
    BarbarianStormHeraldLevel10,
...
def get_starter_class_builder():
    return StarterClassBuilder(
        non_generic_arguments=BarbarianStormHeraldCustomStarterClassArgs(
...
class ExampleBarbarianStormHerald2014CharacterBuilder(CharacterBuilder):
    def __init__(self):
        super().__init__(
            name="Example Storm Herald Barbarian",
