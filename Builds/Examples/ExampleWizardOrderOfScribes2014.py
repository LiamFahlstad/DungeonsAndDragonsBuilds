"""Example build: Wizard Order of Scribes (2014 rules). Demonstrates the subclass through level 14."""
...
from CharacterContent.Classes.SubClasses2014.WizardOrderOfScribes import (
    WizardOrderOfScribesLevel3,
    WizardOrderOfScribesLevel6,
    WizardOrderOfScribesLevel10,
    WizardOrderOfScribesLevel14,
    WizardOrderOfScribesCustomStarterClassArgs,
)
...
def get_starter_class_builder():
    return StarterClassBuilder(
        non_generic_arguments=WizardOrderOfScribesCustomStarterClassArgs(
        ...
        base_class_level_features=ClassBuilder.BaseClassLevelFeatures(
            base_class_features_by_level={
                ...
                6: WizardLevel6(
                    spell=SpellDefinitions.WizardLevel3Spells.FIREBALL,
                ),
                7: WizardLevel7(
            ...
            subclass_features_by_level={
                3: WizardOrderOfScribesLevel3(),
                6: WizardOrderOfScribesLevel6(),
                10: WizardOrderOfScribesLevel10(),
                14: WizardOrderOfScribesLevel14(),
            },
        ),
        replace_spells={},
    )
...
class ExampleWizardOrderOfScribes2014CharacterBuilder(CharacterBuilder):
    def __init__(self):
        super().__init__(
            name="Example Wizard Order of Scribes",
