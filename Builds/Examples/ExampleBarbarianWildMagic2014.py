"""Example build: Barbarian Path of Wild Magic (2014 rules)."""
...
from CharacterContent.Classes.SubClasses2014.BarbarianPathOfWildMagic import (
    BarbarianWildMagicCustomStarterClassArgs,
    BarbarianWildMagicLevel3,
    BarbarianWildMagicLevel6,
    BarbarianWildMagicLevel10,
    BarbarianWildMagicLevel14,
)
...
def get_starter_class_builder():
    return StarterClassBuilder(
        non_generic_arguments=BarbarianWildMagicCustomStarterClassArgs(
        ...
        base_class_level_features=BaseClassLevelFeatures(
            ...
            subclass_features_by_level={
                3: BarbarianWildMagicLevel3(),
                6: BarbarianWildMagicLevel6(),
                10: BarbarianWildMagicLevel10(),
                14: BarbarianWildMagicLevel14(),
            },
        ),
    )


class ExampleBarbarianWildMagic2014CharacterBuilder(CharacterBuilder):
    def __init__(self):
        super().__init__(
            name="Example Wild Magic Barbarian",
