"""Example build: Paladin Oath of Conquest (2014 rules). Demonstrates the subclass up through level 20."""
...
from CharacterContent.Classes.SubClasses2014.PaladinConquest import (
    PaladinConquestLevel3,
    PaladinConquestLevel5,
    PaladinConquestLevel7,
    PaladinConquestLevel9,
    PaladinConquestLevel13,
    PaladinConquestLevel15,
    PaladinConquestLevel17,
    PaladinConquestLevel18,
    PaladinConquestLevel20,
    PaladinConquestCustomStarterClassArgs,
)
...
def get_starter_class_builder():
    return StarterClassBuilder(
        non_generic_arguments=PaladinConquestCustomStarterClassArgs(
        ...
        base_class_level_features=ClassBuilder.BaseClassLevelFeatures(
            base_class_features_by_level={
                1: PaladinLevel1(
                    ...
                    spell_2=PaladinLevel1Spells.WRATHFUL_SMITE,
                ),
                2: PaladinLevel2(
            ...
            subclass_features_by_level={
                3: PaladinConquestLevel3(),
                5: PaladinConquestLevel5(),
                7: PaladinConquestLevel7(),
                9: PaladinConquestLevel9(),
                13: PaladinConquestLevel13(),
                15: PaladinConquestLevel15(),
                17: PaladinConquestLevel17(),
                18: PaladinConquestLevel18(),
                20: PaladinConquestLevel20(),
            },
        ),
        replace_spells={},
    )
...
class ExamplePaladinConquest2014CharacterBuilder(CharacterBuilder):
    def __init__(self):
        super().__init__(
            name="Example Paladin Oath of Conquest",
