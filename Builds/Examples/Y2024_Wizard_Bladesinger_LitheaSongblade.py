"""Example build: Wizard Bladesinging. Adapted from an optimized reference build to demonstrate this subclass."""
...
class Y2024WizardBladesingerLitheaSongbladeCharacterBuilder(CharacterBuilder):
    def __init__(self):
        super().__init__(
            name="Lithea Songblade",
