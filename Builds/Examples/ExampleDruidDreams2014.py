"""Example build: Druid Circle of Dreams (2014 rules). Demonstrates the subclass up through level 14."""
...
from CharacterContent.Classes.SubClasses2014.DruidCircleOfDreams import (
    DruidDreamsCustomStarterClassArgs,
    DruidDreamsLevel3,
    DruidDreamsLevel6,
    DruidDreamsLevel10,
    DruidDreamsLevel14,
...
def get_starter_class_builder():
    return StarterClassBuilder(
        non_generic_arguments=DruidDreamsCustomStarterClassArgs(
        ...
        base_class_level_features=ClassBuilder.BaseClassLevelFeatures(
            ...
            subclass_features_by_level={
                3: DruidDreamsLevel3(),
                6: DruidDreamsLevel6(),
                10: DruidDreamsLevel10(),
                14: DruidDreamsLevel14(),
            },
        ),
        replace_spells={},
    )
...
class ExampleDruidDreams2014CharacterBuilder(CharacterBuilder):
    def __init__(self):
        super().__init__(
            name="Example Circle of Dreams Druid",
