"""Example build: Barbarian Path of the Battlerager (2014 rules)."""
...
from CharacterContent.Classes.SubClasses2014.BarbarianPathOfTheBattlerager import (
    BarbarianBattleragerCustomStarterClassArgs,
    BarbarianBattleragerLevel3,
    BarbarianBattleragerLevel6,
    BarbarianBattleragerLevel10,
    BarbarianBattleragerLevel14,
)
...
def get_starter_class_builder():
    return StarterClassBuilder(
        non_generic_arguments=BarbarianBattleragerCustomStarterClassArgs(
        ...
        base_class_level_features=BaseClassLevelFeatures(
            ...
            subclass_features_by_level={
                3: BarbarianBattleragerLevel3(),
                6: BarbarianBattleragerLevel6(),
                10: BarbarianBattleragerLevel10(),
                14: BarbarianBattleragerLevel14(),
            },
        ),
    )


class ExampleBarbarianBattlerager2014CharacterBuilder(CharacterBuilder):
    def __init__(self):
        super().__init__(
            name="Example Battlerager Barbarian",
