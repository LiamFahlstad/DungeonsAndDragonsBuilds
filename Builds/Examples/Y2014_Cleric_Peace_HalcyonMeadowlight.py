"""Example build: Cleric Peace Domain (2014 rules). Demonstrates the subclass up through level 17."""
...
from CharacterContent.Classes.SubClasses2014.ClericPeace import (
...
def get_starter_class_builder():
    return StarterClassBuilder(
        non_generic_arguments=ClericPeaceCustomStarterClassArgs(
        ...
        base_class_level_features=ClassBuilder.BaseClassLevelFeatures(
            base_class_features_by_level={
                ...
                4: ClericLevel4(
                    ...
                    spell=ClericLevel2Spells.WARDING_BOND,
                ),
                5: ClericLevel5(
                    spell_1=ClericLevel3Spells.BEACON_OF_HOPE,
                    spell_2=ClericLevel3Spells.SENDING,
                ),
                6: ClericLevel6(
                    spell=ClericLevel3Spells.REVIVIFY,
                ),
                7: ClericLevel7(
                    spell=ClericLevel4Spells.AURA_OF_PURITY,
                ...
                9: ClericLevel9(
                    spell_1=ClericLevel5Spells.GREATER_RESTORATION,
...
class Y2014ClericPeaceHalcyonMeadowlightCharacterBuilder(CharacterBuilder):
    def __init__(self):
        super().__init__(
            name="Halcyon Meadowlight",
