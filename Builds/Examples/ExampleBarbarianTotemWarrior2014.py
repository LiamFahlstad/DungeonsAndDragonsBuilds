"""Example build: Barbarian Path of the Totem Warrior (2014 rules)."""
...
from CharacterContent.Classes.SubClasses2014.BarbarianPathOfTheTotemWarrior import (
    BarbarianTotemWarriorCustomStarterClassArgs,
    BarbarianTotemWarriorLevel3,
    BarbarianTotemWarriorLevel6,
...
def get_starter_class_builder():
    return StarterClassBuilder(
        non_generic_arguments=BarbarianTotemWarriorCustomStarterClassArgs(
        ...
        base_class_level_features=BaseClassLevelFeatures(
            ...
            subclass_features_by_level={
                3: BarbarianTotemWarriorLevel3(),
                6: BarbarianTotemWarriorLevel6(),
                10: BarbarianTotemWarriorLevel10(),
                14: BarbarianTotemWarriorLevel14(),
            },
        ),
    )


class ExampleBarbarianTotemWarrior2014CharacterBuilder(CharacterBuilder):
    def __init__(self):
        super().__init__(
            name="Example Totem Warrior Barbarian",
