"""Example build: Warlock Archfey Patron. Adapted from an optimized reference build to demonstrate this subclass."""
...
class Y2024WarlockArchfeyThistleFeydreamCharacterBuilder(CharacterBuilder):
    def __init__(self):
        super().__init__(
            name="Thistle Feydream",
