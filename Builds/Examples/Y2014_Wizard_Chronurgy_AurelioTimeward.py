"""Example build: Wizard School of Chronurgy (2014 rules). Demonstrates the subclass through level 14."""
...
from CharacterContent.Classes.SubClasses2014.WizardChronurgy import (
    WizardChronurgyLevel3,
    WizardChronurgyLevel6,
    WizardChronurgyLevel10,
    WizardChronurgyLevel14,
    WizardChronurgyCustomStarterClassArgs,
)
...
def get_starter_class_builder():
    return StarterClassBuilder(
        non_generic_arguments=WizardChronurgyCustomStarterClassArgs(
        ...
        base_class_level_features=ClassBuilder.BaseClassLevelFeatures(
            base_class_features_by_level={
                ...
                2: WizardLevel2(
                    ...
                    spell=SpellDefinitions.WizardLevel1Spells.IDENTIFY,
                ),
                3: WizardLevel3(
                ...
                5: WizardLevel5(
                    spell_1=SpellDefinitions.WizardLevel3Spells.HASTE,
                    spell_2=SpellDefinitions.WizardLevel3Spells.SLOW,
                ),
                6: WizardLevel6(
            ...
            subclass_features_by_level={
                3: WizardChronurgyLevel3(),
                6: WizardChronurgyLevel6(),
                10: WizardChronurgyLevel10(),
                14: WizardChronurgyLevel14(),
            },
        ),
        replace_spells={},
    )
...
class Y2014WizardChronurgyAurelioTimewardCharacterBuilder(CharacterBuilder):
    def __init__(self):
        super().__init__(
            name="Aurelio Timeward",
