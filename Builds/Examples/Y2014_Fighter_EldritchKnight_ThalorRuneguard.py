...
from CharacterContent.Classes.SubClasses2014.FighterEldritchKnight import (
...
class Y2014FighterEldritchKnightThalorRuneguardCharacterBuilder(CharacterBuilder):
    def __init__(self):
        super().__init__(
            name="Thalor Runeguard",
