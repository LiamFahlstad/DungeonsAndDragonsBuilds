...
from CharacterContent.Features.CharacterFeats import Backgrounds
...
class Y2024RangerHunterTalonSwiftarrowCharacterBuilder(CharacterBuilder):
    def __init__(self):
        super().__init__(
            name="Talon Swiftarrow",
