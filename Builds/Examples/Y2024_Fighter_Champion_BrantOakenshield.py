"""Example build: Fighter Champion. Adapted from an optimized reference build to demonstrate this subclass."""
...
class Y2024FighterChampionBrantOakenshieldCharacterBuilder(CharacterBuilder):
    def __init__(self):
        super().__init__(
            name="Brant Oakenshield",
