...
from CharacterContent.Classes.SubClasses2024.FighterBanneret import (
...
class Y2024FighterBanneretRoderickVanguardCharacterBuilder(CharacterBuilder):
    def __init__(self):
        super().__init__(
            name="Roderick Vanguard",
