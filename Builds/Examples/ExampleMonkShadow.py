"""Example build: Monk Way of Shadow. Adapted from an optimized reference build to demonstrate this subclass."""
...
class ExampleMonkShadowCharacterBuilder(CharacterBuilder):
    def __init__(self):
        super().__init__(
            name="Example Shadow Monk",
