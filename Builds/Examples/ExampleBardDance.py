"""Example build: Bard College of Dance. Adapted from an optimized reference build to demonstrate this subclass."""
...
from CharacterContent.Classes.SubClasses2024.BardDance import (
...
def get_starter_class_builder():
    return StarterClassBuilder(
        non_generic_arguments=BardDanceCustomStarterClassArgs(
        ...
        base_class_level_features=ClassBuilder.BaseClassLevelFeatures(
            base_class_features_by_level={
                ...
                5: BardLevel5(
                    spell_1=BardLevel3Spells.HYPNOTIC_PATTERN,
...
class ExampleBardDanceCharacterBuilder(CharacterBuilder.CharacterBuilder):
    def __init__(self):
        super().__init__(
            name="Example Dance Bard",
