...
from CharacterContent.Classes.SubClasses2024.RoguePhantom import (
...
class Y2024RoguePhantomWraithGrimscarCharacterBuilder(CharacterBuilder):
    def __init__(self):
        super().__init__(
            name="Wraith Grimscar",
