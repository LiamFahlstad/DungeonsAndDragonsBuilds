...
from CharacterContent.Classes.SubClasses2014.ArtificerBattleSmith import (
...
class Y2014ArtificerBattleSmithDorricSteamwellCharacterBuilder(CharacterBuilder):
    def __init__(self):
        super().__init__(
            name="Dorric Steamwell",
