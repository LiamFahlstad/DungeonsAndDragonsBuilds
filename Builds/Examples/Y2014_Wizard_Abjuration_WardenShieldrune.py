"""Example build: Wizard School of Abjuration (2014 rules). Demonstrates the subclass through level 14."""
...
from CharacterContent.Classes.SubClasses2014.WizardAbjuration import (
    WizardAbjurationLevel3,
    WizardAbjurationLevel6,
    WizardAbjurationLevel10,
    WizardAbjurationLevel14,
    WizardAbjurationCustomStarterClassArgs,
)
...
def get_starter_class_builder():
    return StarterClassBuilder(
        non_generic_arguments=WizardAbjurationCustomStarterClassArgs(
        ...
        base_class_level_features=ClassBuilder.BaseClassLevelFeatures(
            base_class_features_by_level={
                ...
                2: WizardLevel2(
                    ...
                    spell=SpellDefinitions.WizardLevel1Spells.PROTECTION_FROM_EVIL_AND_GOOD,
                ),
                3: WizardLevel3(
                ...
                4: WizardLevel4(
                    ...
                    spell=SpellDefinitions.WizardLevel2Spells.ARCANE_LOCK,
                ),
                5: WizardLevel5(
                    spell_1=SpellDefinitions.WizardLevel3Spells.COUNTERSPELL,
                    spell_2=SpellDefinitions.WizardLevel3Spells.DISPEL_MAGIC,
                ),
                6: WizardLevel6(
                    spell=SpellDefinitions.WizardLevel3Spells.PROTECTION_FROM_ENERGY,
                ),
                7: WizardLevel7(
                ...
                9: WizardLevel9(
                    ...
                    spell_2=SpellDefinitions.WizardLevel5Spells.CONE_OF_COLD,
                ),
                10: WizardLevel10(
            ...
            subclass_features_by_level={
                3: WizardAbjurationLevel3(),
                6: WizardAbjurationLevel6(),
                10: WizardAbjurationLevel10(),
                14: WizardAbjurationLevel14(),
            },
        ),
        replace_spells={},
    )
...
class Y2014WizardAbjurationWardenShieldruneCharacterBuilder(CharacterBuilder):
    def __init__(self):
        super().__init__(
            name="Warden Shieldrune",
