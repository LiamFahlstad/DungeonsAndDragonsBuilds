"""Example build: Bard College of Glamour. Adapted from an optimized reference build to demonstrate this subclass."""
...
class ExampleBardGlamourCharacterBuilder(CharacterBuilder.CharacterBuilder):
    def __init__(self):
        super().__init__(
            name="Example Glamour Bard",
