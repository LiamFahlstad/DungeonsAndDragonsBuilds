"""Example build: Paladin Oath of Glory. Adapted from an optimized reference build to demonstrate this subclass."""
...
class Y2024PaladinGloryTitusBattlegloryCharacterBuilder(CharacterBuilder):
    def __init__(self):
        super().__init__(
            name="Titus Battleglory",
