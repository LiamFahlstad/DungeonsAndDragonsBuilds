"""Example build: Warlock The Undying Patron (2014 rules). Demonstrates the subclass up through level 14."""
...
from CharacterContent.Classes.SubClasses2014.WarlockTheUndying import (
    WarlockTheUndyingLevel3,
    WarlockTheUndyingLevel6,
    WarlockTheUndyingLevel10,
    WarlockTheUndyingLevel14,
    WarlockTheUndyingCustomStarterClassArgs,
)
...
def get_starter_class_builder():
    return StarterClassBuilder(
        non_generic_arguments=WarlockTheUndyingCustomStarterClassArgs(
        ...
        base_class_level_features=ClassBuilder.BaseClassLevelFeatures(
            ...
            subclass_features_by_level={
                3: WarlockTheUndyingLevel3(),
                6: WarlockTheUndyingLevel6(),
                10: WarlockTheUndyingLevel10(),
                14: WarlockTheUndyingLevel14(),
            },
        ),
        replace_spells={},
    )
...
class ExampleWarlockTheUndying2014CharacterBuilder(CharacterBuilder):
    def __init__(self):
        super().__init__(
            name="Example Warlock The Undying",
