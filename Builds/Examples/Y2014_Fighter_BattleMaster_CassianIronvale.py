"""Example build: Fighter Battle Master (2014 rules)."""
...
from CharacterContent.Classes.SubClasses2014.FighterBattleMaster import (
    FighterBattleMasterCustomStarterClassArgs,
    FighterBattleMasterLevel3,
    FighterBattleMasterLevel7,
    FighterBattleMasterLevel10,
        ...
        base_class_level_features=BaseClassLevelFeatures(
            ...
            subclass_features_by_level={
                3: FighterBattleMasterLevel3(
                    maneuver_1=Maneuvers.Riposte(),
                    maneuver_2=Maneuvers.TripAttack(),
                    maneuver_3=Maneuvers.PrecisionAttack(),
                ),
                7: FighterBattleMasterLevel7(
                    maneuver_1=Maneuvers.DisarmingAttack(),
                    maneuver_2=Maneuvers.MenacingAttack(),
                ),
                10: FighterBattleMasterLevel10(
                    maneuver_1=Maneuvers.PushingAttack(),
                    maneuver_2=Maneuvers.ManeuveringAttack(),
                ),
                15: FighterBattleMasterLevel15(
                    maneuver_1=Maneuvers.EvasiveFootwork(),
                    maneuver_2=Maneuvers.Parry(),
                ),
...
class Y2014FighterBattleMasterCassianIronvaleCharacterBuilder(CharacterBuilder):
    def __init__(self):
        super().__init__(
            name="Cassian Ironvale",
