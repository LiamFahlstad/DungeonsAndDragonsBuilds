...
class AstralFlood(ExplicitSpell):
    def __init__(
        self,
        spell_casting_ability: Optional[Ability] = None,
        additional_ruling: Optional[str] = None,
...
class BuzzingBee(ExplicitSpell):
    def __init__(
        self,
        spell_casting_ability: Optional[Ability] = None,
        additional_ruling: Optional[str] = None,
...
class InsidiousRhythm(ExplicitSpell):
    def __init__(
        self,
        spell_casting_ability: Optional[Ability] = None,
        additional_ruling: Optional[str] = None,
...
class LeomundsLamentableBelaborment(ExplicitSpell):
    def __init__(
        self,
        spell_casting_ability: Optional[Ability] = None,
        additional_ruling: Optional[str] = None,
...
class SearingOrb(ExplicitSpell):
    def __init__(
        self,
        spell_casting_ability: Optional[Ability] = None,
        additional_ruling: Optional[str] = None,
...
class SticksToSnakes(ExplicitSpell):
    def __init__(
        self,
        spell_casting_ability: Optional[Ability] = None,
        additional_ruling: Optional[str] = None,
...
class TortoiseShell(ExplicitSpell):
    def __init__(
        self,
        spell_casting_ability: Optional[Ability] = None,
        additional_ruling: Optional[str] = None,
        ...
        super().__init__(
            ...
            components="V, S",
            duration="Concentration, up to 1 minute",
            description="You touch a willing creature. Until the spell ends, the target’s skin hardens into a tortoise shell, and the target gains a +3 bonus to AC. If the target moves, the bonus becomes +1 instead until the start of its next turn.",
            source="D&D Beyond Drops - June 2026",
            spell_casting_ability=spell_casting_ability,
            additional_ruling=additional_ruling,
        )
...
SpellSet = {
    ...
    "Insidious Rhythm": InsidiousRhythm,
    ...
    "Leomund's Lamentable Belaborment": LeomundsLamentableBelaborment,
