...
class AdultBlueDragon(ExtendedCombatantData):
    def __init__(self):
        super().__init__(
            ...
            {"name": "Lightning Breath (Recharge 5–6)", "description": "Dexterity Saving Throw: DC 19, each creature in a 90-foot-long, 5-foot-wide Line. Failure: 60 (11d10) Lightning damage. Success: Half damage."},
            {"name": "Spellcasting", "description": "The dragon casts one of the following spells, requiring no Material components and using Charisma as the spellcasting ability (spell save DC 18):"},
        ],
            bonus_actions=[],
            reactions=[],
            legendary_actions=[
...
class AdultSilverDragon(ExtendedCombatantData):
    def __init__(self):
        super().__init__(
            ...
            temp_hp=0,
            conditions=[],
            ability_scores={"Str": 27, "Dex": 10, "Con": 25, "Int": 16, "Wis": 13, "Cha": 22},
            saving_throws={},
            spell_slots={},
            cr="16",
            ...
            {"name": "Cold Breath (Recharge 5–6)", "description": "Constitution Saving Throw: DC 20, each creature in a 60-foot Cone. Failure: 54 (12d8) Cold damage. Success: Half damage."},
            ...
            {"name": "Spellcasting", "description": "The dragon casts one of the following spells, requiring no Material components and using Charisma as the spellcasting ability (spell save DC 19, +11 to hit with spell attacks):"},
        ],
            bonus_actions=[],
            reactions=[],
            legendary_actions=[
...
class GithyankiDracomancer(ExtendedCombatantData):
    def __init__(self):
        super().__init__(
            ...
            temp_hp=0,
            conditions=[],
            ability_scores={"Str": 10, "Dex": 16, "Con": 18, "Int": 20, "Wis": 16, "Cha": 18},
            saving_throws={},
            spell_slots={},
            cr="16",
            ...
            traits=[],
            actions=[
            {"name": "Multiattack", "description": "The githyanki makes three Draconic Strike attacks."},
            {"name": "Draconic Strike", "description": "Melee or Ranged Attack Roll: +10, reach 10 ft. or range 120 ft. Hit: 12 (2d6 + 5) Slashing damage plus 17 (5d6) Fire damage, and the target has the Frightened condition until the start of the githyanki's next turn."},
            {"name": "Conjured Dragon's Breath (Recharge 5–6)", "description": "Dexterity Saving Throw: DC 18, each creature in a 90-foot Cone. Failure: 27 (6d8) Fire damage plus 27 (6d8) Force damage. Success: Half damage."},
            {"name": "Spellcasting", "description": "The githyanki casts one of the following spells, requiring no spell components and using Intelligence as the spellcasting ability (spell save DC 18, +10 to hit with spell attacks):"},
        ],
            bonus_actions=[
            {"name": "Misty Step (3/Day)", "description": "The githyanki casts Misty Step, requiring no spell components and using the same spellcasting ability as Spellcasting."},
        ],
            reactions=[],
            legendary_actions=[],
...
class GulthiasBlight(ExtendedCombatantData):
    def __init__(self):
        super().__init__(
            ...
            temp_hp=0,
            conditions=[],
            ability_scores={"Str": 25, "Dex": 10, "Con": 22, "Int": 10, "Wis": 18, "Cha": 12},
            saving_throws={},
            spell_slots={},
            cr="16",
            ...
            traits=[
            {"name": "Blight Seeds", "description": "When it finishes a Long Rest, the blight expels 1d6 seeds into unoccupied spaces on the ground within 30 feet of itself. After 24 hours, the seeds become creatures under the blight's control. Roll 1d8 for each seed to determine the creature it becomes: on 1-4, Twig Blight; on 5-6, Needle Blight; on 7-8, Vine Blight."},
        ],
            actions=[
            {"name": "Multiattack", "description": "The blight makes two attacks, using Slam or Thorn Volley in any combination. It also uses Life-Draining Root."},
            {"name": "Slam", "description": "Melee Attack Roll: +12, reach 10 ft. Hit: 25 (4d8 + 7) Bludgeoning damage."},
            {"name": "Thorn Volley", "description": "Ranged Attack Roll: +12, range 60/180 ft. Hit: 20 (3d8 + 7) Piercing damage."},
            {"name": "Life-Draining Root", "description": "Constitution Saving Throw: DC 20, one Huge or smaller creature the blight can see within 30 feet. Failure: 14 (2d6 + 7) Necrotic damage, and the target has the Grappled condition (escape DC 17) from one of six roots. Until the grapple ends, the target has the Restrained condition and takes 14 (4d6) Necrotic damage at the start of each of its turns. The target's Hit Point maximum decreases by an amount equal to the Necrotic damage taken, and the blight regains Hit Points equal to that amount."},
        ],
            bonus_actions=[],
            reactions=[],
            legendary_actions=[],
...
class IronGolem(ExtendedCombatantData):
    def __init__(self):
        super().__init__(
            ...
            {"name": "Bladed Arm", "description": "Melee Attack Roll: +12, reach 10 ft. Hit: 20 (3d8 + 7) Slashing damage plus 10 (3d6) Fire damage."},
            {"name": "Fiery Bolt", "description": "Ranged Attack Roll: +10, range 120 ft. Hit: 36 (8d8) Fire damage."},
            {"name": "Poison Breath (Recharge 6)", "description": "Constitution Saving Throw: DC 18, each creature in a 60-foot Cone. Failure: 55 (10d10) Poison damage. Success: Half damage."},
        ],
            bonus_actions=[],
            reactions=[],
            legendary_actions=[],
...
class Marilith(ExtendedCombatantData):
    def __init__(self):
        super().__init__(
            ...
            bonus_actions=[
            {"name": "Teleport (Recharge 5–6)", "description": "The marilith teleports up to 120 feet to an unoccupied space it can see."},
        ],
            reactions=[],
            legendary_actions=[],
            legendary_resistances=0,
...
class Planetar(ExtendedCombatantData):
    def __init__(self):
        super().__init__(
            ...
            {"name": "Spellcasting", "description": "The planetar casts one of the following spells, requiring no Material components and using Charisma as spellcasting ability (spell save DC 20):"},
        ],
            bonus_actions=[
            {"name": "Divine Aid (2/Day)", "description": "The planetar casts Cure Wounds, Invisibility, Lesser Restoration, or Remove Curse, using the same spellcasting ability as Spellcasting."},
        ],
            reactions=[],
            legendary_actions=[],
            legendary_resistances=0,
