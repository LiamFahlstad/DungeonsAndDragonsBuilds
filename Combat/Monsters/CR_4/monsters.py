    ...
    def __init__(self):
        super().__init__(
            ...
            ability_scores={
                ...
                Ability.WISDOM.short_name: 17,
                Ability.CHARISMA.short_name: 12,
            },
            saving_throws={
                Ability.DEXTERITY.short_name: 5,
...
class Couatl(ExtendedCombatantData):
    def __init__(self):
        super().__init__(
            ...
            ability_scores={
                Ability.STRENGTH.short_name: 16,
                Ability.DEXTERITY.short_name: 20,
                Ability.CONSTITUTION.short_name: 17,
                Ability.INTELLIGENCE.short_name: 18,
    ...
    def __init__(self):
        super().__init__(
            ...
            ability_scores={
                ...
                Ability.DEXTERITY.short_name: 9,
                Ability.CONSTITUTION.short_name: 17,
...
class Hippopotamus(ExtendedCombatantData):
    def __init__(self):
        super().__init__(
            ...
            ability_scores={
                Ability.STRENGTH.short_name: 21,
                Ability.DEXTERITY.short_name: 7,
                Ability.CONSTITUTION.short_name: 15,
...
class RedDragonWyrmling(ExtendedCombatantData):
    def __init__(self):
        super().__init__(
            ...
            saving_throws={
                Ability.DEXTERITY.short_name: 2,
                Ability.WISDOM.short_name: 2,
            },
            spell_slots={},
            cr="4",
...
class SwarmOfDretches(ExtendedCombatantData):
    def __init__(self):
        super().__init__(
            ...
            cr="4",
            monster_type=MonsterType.FIEND,
            monster_type_note="Swarm of Small; Demon",
            alignment=Alignment.CHAOTIC_EVIL,
            size=Size.LARGE,
            ac_note="",
            hp_formula="6d10 + 12",
