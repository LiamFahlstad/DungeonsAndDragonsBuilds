...
# fully structured subclass. Affected classes: AarakocraAeromancer, Banshee,
# BoneNaga, BullywugBogSage, Chuul, Couatl, Elephant, Flameskull, Ghost,
# Incubus, JuvenileShadowDragon, Lamia, RedDragonWyrmling, Succubus,
# SwarmOfDretches, Wereboar, Weretiger.
...
class Hippopotamus(ExtendedCombatantData):
    def __init__(self):
        super().__init__(
            ...
            saving_throws={Ability.STRENGTH: 7},
            spell_slots={},
            cr="4",
            monster_type=MonsterType.BEAST,
            monster_type_note="",
