...
class TheBellSaint(ExtendedCombatantData):
    def __init__(self):
        super().__init__(
            ...
            temp_hp=0,
            conditions=[],
            ability_scores={Ability.STRENGTH: 20, Ability.DEXTERITY: 10, Ability.CONSTITUTION: 20, Ability.INTELLIGENCE: 10, Ability.WISDOM: 15, Ability.CHARISMA: 16},
            saving_throws={},
            spell_slots={},
            cr="9",
            ...
            DcMonsterAbility(name='Muffled Toll (Costs 2 Actions)', description='One creature the Bell Saint can see within 30 feet must succeed on a DC 17 Wisdom saving throw or be frightened until the end of its next turn.'),
        ],
