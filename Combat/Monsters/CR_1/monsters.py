    ...
    def __init__(self):
        super().__init__(
            ...
            ability_scores={
                ...
                Ability.DEXTERITY.short_name: 11,
                Ability.CONSTITUTION.short_name: 13,
                Ability.INTELLIGENCE.short_name: 1,
                Ability.WISDOM.short_name: 3,
                Ability.CHARISMA.short_name: 1,
            },
            saving_throws={},
            spell_slots={},
            cr="1",
            size=Size.MEDIUM, monster_type='Construct', alignment=Alignment.UNALIGNED,
            ac_note="",
            hp_formula="6d8 + 6",
...
class BrassDragonWyrmling(ExtendedCombatantData):
    def __init__(self):
        super().__init__(
            ...
            conditions=[],
            ability_scores={
                Ability.STRENGTH.short_name: 15,
            ...
            spell_slots={},
            cr="1",
            size=Size.MEDIUM, monster_type='Dragon (Metallic)', alignment=Alignment.CHAOTIC_GOOD,
            ac_note="",
            hp_formula="4d8 + 4",
...
class BrownBear(ExtendedCombatantData):
    def __init__(self):
        super().__init__(
            ...
            conditions=[],
            ability_scores={
                Ability.STRENGTH.short_name: 17,
                Ability.DEXTERITY.short_name: 12,
                Ability.CONSTITUTION.short_name: 15,
                Ability.INTELLIGENCE.short_name: 2,
                Ability.WISDOM.short_name: 13,
                Ability.CHARISMA.short_name: 7,
            },
            saving_throws={},
            spell_slots={},
            cr="1",
...
class DireWolf(ExtendedCombatantData):
    def __init__(self):
        super().__init__(
            ...
            ability_scores={
                Ability.STRENGTH.short_name: 17,
                Ability.DEXTERITY.short_name: 15,
                Ability.CONSTITUTION.short_name: 15,
                Ability.INTELLIGENCE.short_name: 3,
    ...
    def __init__(self):
        super().__init__(
            ...
            ability_scores={
                ...
                Ability.DEXTERITY.short_name: 12,
                Ability.CONSTITUTION.short_name: 11,
                Ability.INTELLIGENCE.short_name: 14,
            ...
            actions=[
                ...
                MonsterAbility(
                    name="Spellcasting",
                    description="The dryad casts one of the following spells, requiring no Material components and using Charisma as the spellcasting ability (spell save DC 14):",
                ),
            ],
            bonus_actions=[
                MonsterAbility(
...
class EmpyreanIota(ExtendedCombatantData):
    def __init__(self):
        super().__init__(
            ...
            conditions=[],
            ability_scores={
                Ability.STRENGTH.short_name: 1,
                Ability.DEXTERITY.short_name: 14,
                Ability.CONSTITUTION.short_name: 10,
                Ability.INTELLIGENCE.short_name: 15,
            ...
            spell_slots={},
            cr="1",
            size=Size.MEDIUM, monster_type='Celestial or Fiend (Titan)', alignment=Alignment.NEUTRAL,
            ac_note="",
            hp_formula="5d8",
            ...
            traits=[
                MonsterAbility(
                    ...
                    description="The empyrean can move through other creatures and objects as if they were Difficult Terrain. It takes 5 (1d10) Force damage if it ends its turn inside an object.",
                ),
                MonsterAbility(
                    name="Magic Resistance",
            ...
            actions=[
                MonsterAbility(
                    ...
                    description="Melee or Ranged Attack Roll: +5. reach 5 ft. or range 30 ft. Hit: 7 (1d8 + 3) Necrotic or Radiant damage (empyrean's choice).",
                ),
                MonsterAbility(
                    name="Spellcasting",
                    description="The empyrean casts one of the following spells, requiring no Material components and using Wisdom as the spellcasting ability.",
                ),
            ],
            bonus_actions=[
                MonsterAbility(
                    name="Healing Word (1/Day)",
                    description="The empyrean casts Healing Word, using the same spellcasting ability as Spellcasting.",
                ),
            ],
            reactions=[],
            legendary_actions=[],
    ...
    def __init__(self):
        super().__init__(
            ...
            actions=[
                MonsterAbility(
                    name="Bite",
                    description="Melee Attack Roll: +5, reach 5 ft. Hit: 5 (1d4 + 3) Piercing damage plus 2 (1d4) Psychic damage.",
                ),
                MonsterAbility(
                    name="Euphoria Breath (Recharge 5–6)",
                    description="Wisdom Saving Throw: DC 12, each creature in a 15-foot Cone. Failure: The target has the Incapacitated condition until the end of its next turn and uses all its movement on its turn to move in a random direction.",
                ),
                MonsterAbility(
                    name="Spellcasting",
                    description="The dragon casts one of the following spells, requiring no Material components and using Charisma as the spellcasting ability (spell save DC 12):",
                ),
            ],
            bonus_actions=[
                MonsterAbility(
    ...
    def __init__(self):
        super().__init__(
            ...
            ability_scores={
                ...
                Ability.DEXTERITY.short_name: 15,
                Ability.CONSTITUTION.short_name: 10,
                Ability.INTELLIGENCE.short_name: 7,
    ...
    def __init__(self):
        super().__init__(
            ...
            ability_scores={
                ...
                Ability.CHARISMA.short_name: 10,
            },
            saving_throws={},
            spell_slots={},
            cr="1",
            size=Size.LARGE, monster_type='Celestial', alignment=Alignment.NEUTRAL_GOOD,
            ac_note="",
            hp_formula="4d10 + 4",
            speed_ground_ft=10, speed_fly_ft=None, speed_climb_ft=None, speed_special_rules='',
            skills={},
    ...
    def __init__(self):
        super().__init__(
            ...
            ability_scores={
                ...
                Ability.CONSTITUTION.short_name: 13,
                Ability.INTELLIGENCE.short_name: 5,
                Ability.WISDOM.short_name: 10,
        ...
        super().__init__(
            ...
            actions=[
                ...
                MonsterAbility(
                    ...
                    description="Trigger: A creature the goblin can see makes an attack roll against it. Response: The goblin chooses a Medium or Small ally within 5 feet of itself. The goblin and that ally swap places, and the ally becomes the target of the attack instead.",
                ),
            ],
            bonus_actions=[
                MonsterAbility(
...
class Imp(ExtendedCombatantData):
    def __init__(self):
        super().__init__(
            ...
            spell_slots={},
            cr="1",
            size=Size.TINY, monster_type='Fiend (Devil)', alignment=Alignment.LAWFUL_EVIL,
            ac_note="",
            hp_formula="6d4 + 6",
            speed_ground_ft=20, speed_fly_ft=None, speed_climb_ft=None, speed_special_rules='',
            skills={},
    ...
    def __init__(self):
        super().__init__(
            ...
            actions=[
                MonsterAbility(
                    name="Pincer Staff",
                    description="Melee Attack Roll: +4, reach 10 ft. Hit: 9 (2d6 + 2) Piercing damage. If the target is a Medium or smaller creature, it has the Grappled condition (escape DC 12). Until the grapple ends, the kuo-toa can't make Pincer Staff attacks.",
                ),
                MonsterAbility(
                    name="Conjure Slimy Glob",
                    description="Ranged Attack Roll: +4, range 60 ft. Hit: 9 (3d4 + 2) Acid damage.",
                ),
            ],
            bonus_actions=[
                MonsterAbility(
                    name="Shield of Faith (2/Day)",
                    description="The kuo-toa casts Shield of Faith, using Wisdom as the spellcasting ability.",
                ),
            ],
            reactions=[],
            legendary_actions=[],
    ...
    def __init__(self):
        super().__init__(
            ...
            actions=[
                MonsterAbility(
                    name="Multiattack",
                    description="The ghoul makes two Icy Bite attacks.",
                ),
                MonsterAbility(
                    name="Icy Bite",
                    description="Melee Attack Roll: +4, reach 5 ft. Hit: 9 (2d6 + 2) Cold damage, and the target's Speed decreases by 5 feet until the start of the ghoul's next turn.",
                ),
                MonsterAbility(
                    name="Claw",
                    description="Melee Attack Roll: +4, reach 5 ft. Hit: 4 (1d4 + 2) Slashing damage. If the target is a creature that isn't an Undead or elf, it is subjected to the following effect. Constitution Saving Throw: DC 10. Failure: The target has the Paralyzed condition until the end of its next turn.",
            ...
            bonus_actions=[
                MonsterAbility(
                    name="Watery Rush",
                    description="While underwater, the ghoul moves up to half its Swim Speed without provoking Opportunity Attacks.",
                ),
            ],
            reactions=[],
            legendary_actions=[],
    ...
    def __init__(self):
        super().__init__(
            ...
            traits=[
                MonsterAbility(
                    name="Contortionist",
                    description="The manes can move through a space as narrow as 1 inch without expending extra movement to do so.",
                ),
                MonsterAbility(
                    name="Sickening Vapors",
                    description="Constitution Saving Throw: DC 12, each creature in a 5-foot Emanation originating from the manes at the end of the manes's turn. Failure: The target has the Incapacitated condition until the end of its next turn. Success: The target is immune to this manes's Sickening Vapors for 24 hours.",
                ),
            ],
            actions=[
                MonsterAbility(
                    name="Claw",
                    description="Melee Attack Roll: +4, reach 5 ft. Hit: 5 (1d6 + 2) Slashing damage plus 5 (2d4) Necrotic damage.",
                ),
            ],
            bonus_actions=[
                MonsterAbility(
                    name="Shadow Stealth",
                    description="While in Dim Light or Darkness, the manes takes the Hide action.",
                ),
            ],
            reactions=[],
            legendary_actions=[],
...
class MyconidSporeServant(ExtendedCombatantData):
    def __init__(self):
        super().__init__(
            ...
            spell_slots={},
            cr="1",
            size=Size.MEDIUM, monster_type='Plant', alignment=Alignment.UNALIGNED,
            ac_note="",
            hp_formula="5d8 + 15",
            speed_ground_ft=None, speed_fly_ft=None, speed_climb_ft=None, speed_special_rules='',
            skills={},
            ...
            actions=[
                MonsterAbility(
                    name="Slom",
                    description="Melee Attack Roll: +5, reach 5 ft. Hit:6 (1d6 + 3) Bludgeoning damage plus 2 (1d4) Poison damage.",
                ),
            ],
            bonus_actions=[],
            reactions=[],
    ...
    def __init__(self):
        super().__init__(
            ...
            actions=[
                MonsterAbility(
                    name="Multiattack",
                    description="The pirate makes two Dagger attacks. It can replace one of these attacks with a use of Enthralling Panache.",
                ),
                MonsterAbility(
                    name="Dagger",
    ...
    def __init__(self):
        super().__init__(
            ...
            ability_scores={
                ...
                Ability.INTELLIGENCE.short_name: 10,
                Ability.WISDOM.short_name: 6,
                Ability.CHARISMA.short_name: 2,
            },
            saving_throws={},
            spell_slots={},
            cr="1",
            size=Size.MEDIUM, monster_type='Ooze', alignment=Alignment.UNALIGNED,
            ac_note="",
            hp_formula="5d8 + 15",
            speed_ground_ft=10, speed_fly_ft=None, speed_climb_ft=None, speed_special_rules='',
            skills={},
...
class Quasit(ExtendedCombatantData):
    def __init__(self):
        super().__init__(
            ...
            spell_slots={},
            cr="1",
            size=Size.TINY, monster_type='Fiend (Demon)', alignment=Alignment.CHAOTIC_EVIL,
            ac_note="",
            hp_formula="10d4",
            speed_ground_ft=10, speed_fly_ft=None, speed_climb_ft=None, speed_special_rules='',
            skills={},
...
class SalamanderFireSnake(ExtendedCombatantData):
    def __init__(self):
        super().__init__(
            ...
            spell_slots={},
            cr="1",
            size=Size.MEDIUM, monster_type='Elemental', alignment=Alignment.NEUTRAL_EVIL,
            ac_note="",
            hp_formula="6d8",
            speed_ground_ft=30, speed_fly_ft=None, speed_climb_ft=None, speed_special_rules='',
            skills={},
            ...
            traits=[
                MonsterAbility(
                    name="Fire Aura",
                    description="At the end of each of the salamander's turns, each creature of the salamander's choice in a 5-foot Emanation originating from the salamander takes 3 (1d6) Fire damage.",
                ),
            ],
            actions=[
                MonsterAbility(
                    name="Bite",
                    description="Melee Attack Roll: +4, reach 5 ft. Hit: 6 (1d8 + 2) Piercing damage plus 3 (1d6) Fire damage.",
                ),
            ],
            bonus_actions=[],
            reactions=[],
...
class Scarecrow(ExtendedCombatantData):
    def __init__(self):
        super().__init__(
            ...
            spell_slots={},
            cr="1",
            size=Size.MEDIUM, monster_type='Construct', alignment=Alignment.CHAOTIC_EVIL,
            ac_note="",
            hp_formula="6d8",
            speed_ground_ft=None, speed_fly_ft=None, speed_climb_ft=None, speed_special_rules='',
            skills={},
            ...
            actions=[
                MonsterAbility(
                    name="Fearsome Claw",
                    description="Melee Attack Roll: +3, reach 5 ft. Hit: 6 (2d4 + 1) Slashing damage, and the target has the Frightened condition until the end of the scarecrow's next turn.",
                ),
                MonsterAbility(
                    name="Terrifying Glare",
                    description="Wisdom Saving Throw: DC 11, one creature the scarecrow can see within 30 feet. Failure: The target has the Frightened condition until the end of the scarecrow's next turn. While Frightened, the target has the Paralyzed condition.",
                ),
            ],
            bonus_actions=[],
            reactions=[],
...
class SphinxOfWonder(ExtendedCombatantData):
    def __init__(self):
        super().__init__(
            ...
            spell_slots={},
            cr="1",
            size=Size.TINY, monster_type='Celestial', alignment=Alignment.LAWFUL_GOOD,
            ac_note="",
            hp_formula="7d4 + 7",
            speed_ground_ft=20, speed_fly_ft=None, speed_climb_ft=None, speed_special_rules='',
            skills={},
...
class SwarmOfLarvae(ExtendedCombatantData):
    def __init__(self):
        super().__init__(
            ...
            spell_slots={},
            cr="1",
            size=Size.LARGE, monster_type='swarm of Medium Fiends', alignment=Alignment.NEUTRAL_EVIL,
            ac_note="",
            hp_formula="3d10 + 6",
            speed_ground_ft=None, speed_fly_ft=None, speed_climb_ft=None, speed_special_rules='',
            skills={},
            ...
            actions=[
                MonsterAbility(
                    name="Bites",
                    description="Melee Attack Roll: +4, reach 5 ft. Hit: 9 (2d6 + 2) Necrotic damage, or 7 (2d4 + 2) Necrotic damage if the swarm is Bloodied.",
                ),
            ],
            bonus_actions=[],
            reactions=[],
    ...
    def __init__(self):
        super().__init__(
            ...
            ability_scores={
                Ability.STRENGTH.short_name: 13,
                Ability.DEXTERITY.short_name: 16,
                Ability.CONSTITUTION.short_name: 9,
                Ability.INTELLIGENCE.short_name: 1,
                Ability.WISDOM.short_name: 7,
                Ability.CHARISMA.short_name: 2,
            },
            saving_throws={},
            spell_slots={},
    ...
    def __init__(self):
        super().__init__(
            ...
            actions=[
                MonsterAbility(
                    name="Multiattack",
                    description="The thri-kreen makes two attacks, using Gythka or Chatkcha in any combination.",
                ),
                MonsterAbility(
                    name="Gythka",
                    description="Melee Attack Roll: +3, reach 5 ft. Hit: 5 (1d8 + 1) Slashing damage plus 2 (1d4) Poison damage.",
                ),
                MonsterAbility(
                    name="Chatkcha",
                    description="Ranged Attack Roll: +4, range 30/120 ft. Hit: 5 (1d6 + 2) Slashing damage.",
                ),
            ],
            bonus_actions=[
                MonsterAbility(
                    name="Leap",
                    description="The thri-kreen jumps up to 15 feet by spending 5 feet of movement.",
                ),
            ],
            reactions=[],
            legendary_actions=[],
    ...
    def __init__(self):
        super().__init__(
            ...
            actions=[
                MonsterAbility(
                    name="Multiattack",
                    description="The yuan-ti makes two Scimitar attacks.",
                ),
                MonsterAbility(
                    name="Scimitar",
                ...
                MonsterAbility(
                    name="Poison Ray",
                    description="Ranged Attack Roll: +4, range 120 ft. Hit: 9 (2d6 + 2) Poison damage.",
                ),
                MonsterAbility(
                    name="Spellcasting",
                    description="The yuan-ti casts one of the following spells, requiring no Material components and using Wisdom as the spellcasting ability (spell save DC 12):",
                ),
            ],
            bonus_actions=[],
            reactions=[],
