...
class AdultBronzeDragon(ExtendedCombatantData):
    def __init__(self):
        super().__init__(
            ...
            temp_hp=0,
            conditions=[],
            ability_scores={"Str": 25, "Dex": 10, "Con": 23, "Int": 16, "Wis": 15, "Cha": 20},
            saving_throws={},
            spell_slots={},
            cr="15",
            ...
            {"name": "Lightning Breath (Recharge 5–6)", "description": "Dexterity Saving Throw: DC 19, each creature in a 90-foot-long, 5-foot-wide Line. Failure: 55 (10d10) Lightning damage. Success: Half damage."},
            ...
            {"name": "Spellcasting", "description": "The dragon casts one of the following spells, requiring no Material components and using Charisma as the spellcasting ability (spell save DC 17, +10 to hit with spell attacks):"},
        ],
            bonus_actions=[],
            reactions=[],
            legendary_actions=[
...
class AdultGreenDragon(ExtendedCombatantData):
    def __init__(self):
        super().__init__(
            ...
            {"name": "Poison Breath (Recharge 5–6)", "description": "Constitution Saving Throw: DC 18, each creature in a 60-foot Cone. Failure: 56 (16d6) Poison damage. Success: Half damage."},
...
class MummyLord(ExtendedCombatantData):
    def __init__(self):
        super().__init__(
            ...
            temp_hp=0,
            conditions=[],
            ability_scores={"Str": 18, "Dex": 10, "Con": 17, "Int": 11, "Wis": 19, "Cha": 16},
            saving_throws={},
            spell_slots={},
            cr="15",
            ...
            traits=[
            {"name": "Legendary Resistance (3/Day, or 4/Day in Lair)", "description": "If the mummy fails a saving throw, it can choose to succeed instead."},
            ...
            actions=[
            {"name": "Multiattack", "description": "The mummy makes one Rotting Fist or Channel Negative Energy attack, and it uses Dreadful Glare."},
            ...
            {"name": "Spellcasting", "description": "The mummy casts one of the following spells, requiring no Material components and using Wisdom as the spellcasting ability (spell save DC 17, +9 to hit with spell attacks):"},
...
class SalamanderInfernoMaster(ExtendedCombatantData):
    def __init__(self):
        super().__init__(
            ...
            temp_hp=0,
            conditions=[],
            ability_scores={"Str": 24, "Dex": 16, "Con": 18, "Int": 14, "Wis": 10, "Cha": 20},
            saving_throws={},
            spell_slots={},
            cr="15",
            ...
            traits=[
            {"name": "Fire Aura", "description": "At the end of each of the salamander's turns, each creature of the salamander's choice in a 10-foot Emanation originating from the salamander takes 10 (3d6) Fire damage."},
            {"name": "Magic Resistance", "description": "The salamander has Advantage on saving throws against spells and other magical effects."},
        ],
            actions=[
            {"name": "Multiattack", "description": "The salamander makes two Flame Trident attacks."},
            {"name": "Flame Trident", "description": "Melee or Ranged Attack Roll: +12, reach 5 ft. or range 30/90 ft. Hit: 16 (2d8 + 7) Piercing damage plus 14 (4d6) Fire damage. Hit or Miss: The trident magically returns to the salamander's hand immediately after a ranged attack."},
            {"name": "Inferno Blast (Recharge 5–6)", "description": "Dexterity Saving Throw: DC 18, each creature in a 30-foot-radius Sphere centered on a point the salamander can see within 120 feet. Failure: 35 (10d6) Fire damage, and the target starts burning, taking 5 (1d10) Fire damage at the start of each of its turns instead of the normal burning damage. The target gains 1 Exhaustion level whenever it takes this burning damage. Success: Half damage only."},
        ],
            bonus_actions=[
            {"name": "Blazing Movement", "description": "The salamander moves up to its Speed without provoking Opportunity Attacks. During this movement, fire fills a 5-foot Emanation originating from the salamander. When the Emanation enters a creature's space, that creature takes 7 (2d6) Fire damage. A creature can take this damage only once per turn."},
        ],
            reactions=[],
            legendary_actions=[],
            legendary_resistances=0,
...
class VampireUmbralLord(ExtendedCombatantData):
    def __init__(self):
        super().__init__(
            ...
            temp_hp=0,
            conditions=[],
            ability_scores={"Str": 20, "Dex": 18, "Con": 18, "Int": 19, "Wis": 16, "Cha": 21},
            saving_throws={},
            spell_slots={},
            cr="15",
            ...
            {"name": "Shadow Escape", "description": "If the vampire drops to 0 Hit Points outside its resting place, it teleports into its resting place unless it is in running water or sunlight. If it can't teleport, it is destroyed. Once inside its resting place, it has the Paralyzed condition for 1 hour, after which it regains 1 Hit Point."},
            ...
            actions=[
            {"name": "Multiattack", "description": "The vampire makes two attacks, using Grave Strike or Sickening Ray in any combination."},
            {"name": "Grave Strike", "description": "Melee Attack Roll: +10, reach 5 ft. Hit: 9 (1d8 + 5) Slashing damage plus 13 (3d8) Necrotic damage."},
            {"name": "Hunger of Hadar (Recharge 5–6)", "description": "The vampire casts Hunger of Hadar (level 5 version), requiring no spell components and using Charisma as the spellcasting ability (spell save DC 18)."},
            {"name": "Sickening Ray", "description": "Ranged Attack Roll: +10, range 120 ft. Hit: 16 (2d10 + 5) Necrotic damage, and the target has the Poisoned condition until the start of the vampire's next turn."},
        ],
            bonus_actions=[
            {"name": "Sanguine Drain", "description": "Constitution Saving Throw: DC 18, one creature the vampire can see within 30 feet that isn't a Construct or an Undead. Failure: 14 (4d6) Necrotic damage. The target's Hit Point maximum decreases by an amount equal to the damage taken, and the vampire regains Hit Points equal to that amount."},
        ],
            reactions=[],
            legendary_actions=[
            {"name": "Beguile", "description": "The vampire casts Command, requiring no spell components and using Charisma as the spellcasting ability (spell save DC 18). The vampire can't take this action again until the start of its next turn."},
            {"name": "Umbral Strike", "description": "The vampire moves up to half its Speed, and it makes one Grave Strike or Sickening Ray attack."},
        ],
            legendary_resistances=3,
            lair_actions=[],
            mythic_actions=[],
