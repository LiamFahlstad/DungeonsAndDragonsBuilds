...
class Balor(ExtendedCombatantData):
    def __init__(self):
        super().__init__(
            ...
            bonus_actions=[
            {"name": "Teleport", "description": "The balor teleports itself or a willing demon within 10 feet of itself up to 60 feet to an unoccupied space the balor can see."},
        ],
            reactions=[],
            legendary_actions=[],
