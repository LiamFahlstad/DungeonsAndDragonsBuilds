...
#
# NOTE: A handful of classes in this file (Aboleth, DeathSlaad, Deva,
# YoungGoldDragon) have been hand-edited to demonstrate the structured
# MonsterAbility subclasses in Combat/Definitions.py (MeleeAttack,
# SavingThrowEffect, Amphibious, LegendaryResistance, MagicResistance,
# Regeneration). Re-running generate_monsters.py will overwrite these back
# to plain MonsterAbility(...) calls.
        ...
        super().__init__(
            ...
            actions=[
                ...
                MeleeAttack(
                    ...
                    additional_ruling="Plus 10 (3d6) Necrotic damage. Until the start of the slaad's next turn, the target has a condition determined by rolling 1d4: on a 1, Charmed; on a 2, Frightened; on a 3, Poisoned; or on a 4, Incapacitated.",
                ),
                MonsterAbility(
                    name="Spellcasting",
        ...
        super().__init__(
            ...
            actions=[
                ...
                MeleeAttack(
                    ...
                    damage_bonus=4,
                    damage_type=DamageType.BLUDGEONING,
                    additional_ruling="Plus 18 (4d8) Radiant damage.",
                ),
                MonsterAbility(
                    name="Spellcasting",
