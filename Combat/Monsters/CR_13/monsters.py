...
class AdultBrassDragon(ExtendedCombatantData):
    def __init__(self):
        super().__init__(
            ...
            {"name": "Fire Breath (Recharge 5–6)", "description": "Dexterity Saving Throw: DC 18, each creature in a 60-foot-long, 5-foot-wide Line. Failure: 45 (10d8) Fire damage. Success: Half damage."},
            ...
            {"name": "Spellcasting", "description": "The dragon casts one of the following spells, requiring no Material components and using Charisma as the spellcasting ability (spell save DC 16):"},
        ],
            bonus_actions=[],
            reactions=[],
            legendary_actions=[
...
class AdultWhiteDragon(ExtendedCombatantData):
    def __init__(self):
        super().__init__(
            ...
            temp_hp=0,
            conditions=[],
            ability_scores={"Str": 22, "Dex": 10, "Con": 22, "Int": 8, "Wis": 12, "Cha": 12},
            saving_throws={},
            spell_slots={},
            cr="13",
            ...
            {"name": "Cold Breath (Recharge 5–6)", "description": "Constitution Saving Throw: DC 19, each creature in a 60-foot Cone. Failure: 54 (12d8) Cold damage. Success: Half damage."},
        ],
            bonus_actions=[],
            reactions=[],
            legendary_actions=[
...
class Beholder(ExtendedCombatantData):
    def __init__(self):
        super().__init__(
            ...
            temp_hp=0,
            conditions=[],
            ability_scores={"Str": 16, "Dex": 14, "Con": 18, "Int": 17, "Wis": 15, "Cha": 17},
            saving_throws={},
            spell_slots={},
            cr="13",
...
class Nalfeshnee(ExtendedCombatantData):
    def __init__(self):
        super().__init__(
            ...
            {"name": "Pursuit", "description": "Trigger: Another creature the nalfeshnee can see ends its move within 120 feet of the nalfeshnee. Response: The nalfeshnee uses Teleport, but its destination space must be within 10 feet of the triggering creature."},
        ],
            bonus_actions=[
            {"name": "Horror Nimbus (Recharge 5–6)", "description": "Wisdom Saving Throw: DC 15, each creature in a 15-foot Emanation originating from the nalfeshnee. Failure: 28 (8d6) Psychic damage, and the target has the Frightened condition for 1 minute, until it takes damage, or until it ends its turn with the nalfeshnee out of line of sight. Success: The target is immune to this nalfeshnee's Horror Nimbus for 24 hours."},
        ],
            reactions=[],
            legendary_actions=[],
            legendary_resistances=0,
...
class Rakshasa(ExtendedCombatantData):
    def __init__(self):
        super().__init__(
            ...
            temp_hp=0,
            conditions=[],
            ability_scores={"Str": 14, "Dex": 17, "Con": 18, "Int": 13, "Wis": 16, "Cha": 20},
            saving_throws={},
            spell_slots={},
            cr="13",
            ...
            actions=[
            {"name": "Multiattack", "description": "The rakshasa makes three Cursed Touch attacks."},
            ...
            {"name": "Baleful Command (Recharge 5–6)", "description": "Wisdom Saving Throw: DC 18, each enemy in a 30-foot Emanation originating from the rakshasa. Failure: 28 (8d6) Psychic damage, and the target has the Frightened and Incapacitated conditions until the start of the rakshasa's next turn."},
            {"name": "Spellcasting", "description": "The rakshasa casts one of the following spells, requiring no Material components and using Charisma as the spellcasting ability (spell save DC 18):"},
        ],
            bonus_actions=[],
            reactions=[],
            legendary_actions=[],
...
class ShadowDragon(ExtendedCombatantData):
    def __init__(self):
        super().__init__(
            ...
            temp_hp=0,
            conditions=[],
            ability_scores={"Str": 21, "Dex": 19, "Con": 18, "Int": 14, "Wis": 12, "Cha": 18},
            saving_throws={},
            spell_slots={},
            cr="13",
            monster_type="Huge Dragon, Chaotic Evil",
            ac_note="",
            hp_formula="18d12 + 72",
            speed="40 ft.,",
            skills={},
            ...
            actions=[
            {"name": "Multiattack", "description": "The dragon makes three Rend attacks."},
            {"name": "Rend", "description": "Melee Attack Roll: +10, reach 10 ft. Hit: 12 (2d6 + 5) Slashing damage plus 3 (1d6) Necrotic damage."},
            ...
            legendary_actions=[
            {"name": "Pounce", "description": "The dragon moves up to half its Speed, and it makes one Rend attack."},
            {"name": "Veil of Shadow", "description": "The dragon uses Shadow Stealth, and one creature of its choice that it can see within 10 feet of it takes 10 (3d6) Necrotic damage. The dragon can't take this action again until the start of its next turn."},
        ],
            legendary_resistances=3,
            lair_actions=[],
            mythic_actions=[],
...
class StormGiant(ExtendedCombatantData):
    def __init__(self):
        super().__init__(
            ...
            temp_hp=0,
            conditions=[],
            ability_scores={"Str": 29, "Dex": 14, "Con": 20, "Int": 16, "Wis": 20, "Cha": 18},
            saving_throws={},
            spell_slots={},
            cr="13",
            monster_type="Huge Giant, Chaotic Good",
            ac_note="",
            ...
            actions=[
            {"name": "Multiattack", "description": "The giant makes two attacks, using Storm Sword or Thunderbolt in any combination."},
            ...
            {"name": "Lightning Storm (Recharge 5–6)", "description": "Dexterity Saving Throw: DC 18, each creature in a 10-foot-radius, 40-foot-high Cylinder originating from a point the giant can see within 500 feet. Failure: 55 (10d10) Lightning damage. Success: Half damage."},
            {"name": "Spellcasting", "description": "The giant casts one of the following spells, requiring no Material components and using Wisdom as the spellcasting ability (spell save DC 18):"},
        ],
            bonus_actions=[],
            reactions=[],
            legendary_actions=[],
...
class Ultroloth(ExtendedCombatantData):
    def __init__(self):
        super().__init__(
            ...
            temp_hp=0,
            conditions=[],
            ability_scores={"Str": 19, "Dex": 16, "Con": 18, "Int": 19, "Wis": 15, "Cha": 18},
            saving_throws={},
            spell_slots={},
            cr="13",
            ...
            traits=[
            {"name": "Fiendish Restoration", "description": "If the ultroloth dies outside Gehenna, its body dissolves into ichor, and it gains a new body instantly, reviving with all its Hit Points somewhere in Gehenna."},
            {"name": "Magic Resistance", "description": "The ultroloth has Advantage on saving throws against spells and other magical effects."},
        ],
            actions=[
            {"name": "Multiattack", "description": "The ultroloth uses Hypnotic Gaze and makes two Mercurial Whip attacks."},
            {"name": "Mercurial Whip", "description": "Melee Attack Roll: +9, reach 15 ft. Hit: 25 (6d6 + 4) Force damage, and the ultroloth can teleport the target up to 10 feet to an unoccupied space the ultroloth can see that isn't in the air."},
            {"name": "Hypnotic Gaze", "description": "Wisdom Saving Throw: DC 17, each creature in a 30-foot Cone. Failure: 10 (3d6) Psychic damage, and the target has the Stunned condition until the start of the ultroloth's next turn. Success: The target is immune to this ultroloth's Hypnotic Gaze for 24 hours."},
            {"name": "Spellcasting", "description": "The ultroloth casts one of the following spells, requiring no Material components and using Intelligence as the spellcasting ability (spell save DC 17):"},
        ],
            bonus_actions=[
            {"name": "Fiendish Guile (Recharge 4–6)", "description": "The ultroloth casts Dispel Magic, Invisibility (self only), Misty Step, or Suggestion, requiring no Material components and using the same spellcasting ability as Spellcasting."},
        ],
            reactions=[],
            legendary_actions=[],
            legendary_resistances=0,
