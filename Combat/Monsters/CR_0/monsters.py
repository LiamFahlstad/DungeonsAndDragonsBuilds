...
#
# NOTE: Many classes in this file have been hand-edited to use the
# structured MonsterAbility subclasses in Combat/Definitions.py
# (Amphibious, MagicResistance, MeleeAttack, Multiattack, NimbleEscape,
# PackTactics, Rampage, RangedAttack, SavingThrowEffect, SpiderClimb,
# SunlightSensitivity, WebWalker, Illumination) instead of plain
...
class AberrantSpirit(ExtendedCombatantData):
    def __init__(self):
        super().__init__(
            ...
            actions=[
                Multiattack(
                    creature_name="spirit",
                    attacks_text="a number of attacks equal to half this spell's level (round down)",
                ),
                MonsterAbility(
...
class Ape(ExtendedCombatantData):
    def __init__(self):
        super().__init__(
            ...
            traits=[],
            actions=[
                Multiattack(creature_name="ape", attacks_text="two Fist attacks"),
                MeleeAttack(
                    name="Fist",
                    attack_bonus=5,
                    reach_ft=5,
...
class Baboon(ExtendedCombatantData):
    def __init__(self):
        super().__init__(
            ...
            languages="None",
            traits=[
                PackTactics(creature_name="baboon"),
            ],
            actions=[
                MeleeAttack(
                    name="Bite",
...
class BeastOfTheSea(ExtendedCombatantData):
    def __init__(self):
        super().__init__(
            ...
            languages="Understands the languages you know",
            traits=[
                Amphibious(creature_name="beast"),
                PrimalBond(),
            ],
            actions=[
                MonsterAbility(
    ...
    def __init__(self):
        super().__init__(
            ...
            traits=[
                ...
                PackTactics(creature_name="spirit", name_suffix="Land and Water Only"),
                MonsterAbility(
            ...
            actions=[
                Multiattack(
                    creature_name="spirit",
                    attacks_text="a number of Rend attacks equal to half this spell's level (round down)",
                ),
                MonsterAbility(
                    name="Rend",
...
class BlackBear(ExtendedCombatantData):
    def __init__(self):
        super().__init__(
            ...
            traits=[],
            actions=[
                Multiattack(creature_name="bear", attacks_text="two Rend attacks"),
                MeleeAttack(
                    name="Rend",
                    attack_bonus=4,
                    reach_ft=5,
...
class BloodHawk(ExtendedCombatantData):
    def __init__(self):
        super().__init__(
            ...
            languages="None",
            traits=[
                PackTactics(creature_name="hawk"),
            ],
            actions=[
                MonsterAbility(
                    name="Beak",
        ...
        super().__init__(
            ...
            actions=[
                MeleeAttack(
                    ...
                    damage_bonus=1,
                    damage_type=DamageType.PIERCING,
                    additional_ruling="If the target is a Medium or smaller creature and the boar moved 20+ feet straight toward it immediately before the hit, the target takes an extra 3 (1d6) Piercing damage and has the Prone condition.",
                ),
            ],
            bonus_actions=[],
            reactions=[],
...
class BullywugWarrior(ExtendedCombatantData):
    def __init__(self):
        super().__init__(
            ...
            traits=[
                Amphibious(creature_name="bullywug"),
                MonsterAbility(
        ...
        super().__init__(
            ...
            actions=[
                ...
                SavingThrowEffect(
                    ...
                    dc=12,
                    target="one Medium or smaller creature the snake can see within 5 feet",
                    dice_count=3,
                    dice_type=DiceType.D4,
                    damage_bonus=0,
                    damage_type=DamageType.BLUDGEONING,
                    failure_effect="and the target has the Grappled condition (escape DC 12)",
                ),
            ],
            bonus_actions=[],
            reactions=[],
    ...
    def __init__(self):
        super().__init__(
            ...
            actions=[
                Multiattack(
                    creature_name="spirit",
                    attacks_text="a number of Slam attacks equal to half this spell's level (round down)",
                ),
                MonsterAbility(
                    name="Slam",
        ...
        super().__init__(
            ...
            actions=[
                MeleeAttack(
                    ...
                    damage_bonus=2,
                    damage_type=DamageType.PIERCING,
                    additional_ruling="If the target is Medium or smaller, it has the Grappled condition (escape DC 12). While Grappled, the target has the Restrained condition.",
                ),
            ],
            bonus_actions=[],
            reactions=[],
    ...
    def __init__(self):
        super().__init__(
            ...
            actions=[
                Multiattack(
                    creature_name="spirit",
                    attacks_text="a number of Rend attacks equal to half the spell's level (round down), and it uses Breath Weapon",
                ),
                MonsterAbility(
                    name="Rend",
                ...
                SavingThrowEffect(
                    ...
                    dice_count=0,
                    damage_type=None,
                    failure_effect="2d6 damage of a type this spirit has Resistance to (your choice when you cast the spell).",
        ...
        super().__init__(
            ...
            actions=[
                ...
                SavingThrowEffect(
                    ...
                    dc=11,
                    target="each creature in a 10-foot Emanation originating from the dretch",
                    dice_count=0,
                    damage_type=None,
                    failure_effect="The target has the Poisoned condition until the end of its next turn. While Poisoned, the creature can take either an action or a Bonus Action on its turn, not both, and it can't take Reactions.",
                ),
            ],
            bonus_actions=[],
            reactions=[],
        ...
        super().__init__(
            ...
            actions=[
                ...
                SavingThrowEffect(
                    ...
                    ability=Ability.DEXTERITY,
                    dc=10,
                    target="each creature in a 15-foot Cone",
                    dice_count=0,
                    damage_type=None,
    ...
    def __init__(self):
        super().__init__(
            ...
            damage_resistances=[
                ...
                DamageTypeEntry(
                    damage_types=[], note="Lightning and Thunder (Air only)"
                ),
                DamageTypeEntry(
                    damage_types=[], note="Piercing and Slashing (Earth only)"
                ),
            ],
            damage_immunities=[
        ...
        super().__init__(
            ...
            actions=[
                MeleeAttack(
                    ...
                    damage_bonus=3,
                    damage_type=DamageType.BLUDGEONING,
                    additional_ruling="If the elk moved at least 20 feet straight toward the target immediately before the hit, the target takes an extra 3 (1d6) Bludgeoning damage and, if it is Huge or smaller, has the Prone condition.",
                ),
            ],
            bonus_actions=[],
            reactions=[],
    ...
    def __init__(self):
        super().__init__(
            ...
            actions=[
                Multiattack(
                    creature_name="spirit",
                    attacks_text="a number of Fey Blade attacks equal to half this spell's level (round down)",
                ),
                MonsterAbility(
                    name="Fey Blade",
    ...
    def __init__(self):
        super().__init__(
            ...
            traits=[
                ...
                MagicResistance(creature_name="spirit"),
            ],
            actions=[
                Multiattack(
                    creature_name="spirit",
        ...
        super().__init__(
            ...
            actions=[
                MeleeAttack(
                    ...
                    damage_bonus=1,
                    damage_type=DamageType.BLUDGEONING,
                    additional_ruling="If the target is a Medium or smaller creature, it has the Grappled condition (escape DC 11) from one of two claws.",
                ),
            ],
            bonus_actions=[],
            reactions=[],
...
class GiantFireBeetle(ExtendedCombatantData):
    def __init__(self):
        super().__init__(
            ...
            languages="None",
            traits=[
                Illumination(creature_name="beetle", radius_ft=10, dim_radius_ft=10),
            ],
            actions=[
                MonsterAbility(
                    name="Bite",
        ...
        super().__init__(
            ...
            actions=[
                MeleeAttack(
                    ...
                    damage_bonus=2,
                    damage_type=DamageType.PIERCING,
                    additional_ruling="If the target is a Medium or smaller creature, it has the Grappled condition (escape DC 11).",
                ),
                MonsterAbility(
                    name="Swallow",
        ...
        super().__init__(
            ...
            actions=[
                MeleeAttack(
                    ...
                    damage_bonus=3,
                    damage_type=DamageType.BLUDGEONING,
                    additional_ruling="If the target is a Large or smaller creature and the goat moved 20+ feet straight toward it immediately before the hit, the target takes an extra 5 (2d4) Bludgeoning damage and has the Prone condition.",
                ),
            ],
            bonus_actions=[],
            reactions=[],
...
class GiantInsect(ExtendedCombatantData):
    def __init__(self):
        super().__init__(
            ...
            languages="Understands the languages you know",
            traits=[
                SpiderClimb(creature_name="insect"),
            ],
            actions=[
                Multiattack(
                    creature_name="insect",
                    attacks_text="a number of attacks equal to half this spell's level (round down)",
                ),
                MonsterAbility(
                    name="Poison Jab",
            ...
            bonus_actions=[
                SavingThrowEffect(
                    ...
                    ability=Ability.CONSTITUTION,
                    dc="equals your spell save DC",
                    target="one creature the insect can see within 10 feet",
                    dice_count=0,
                    damage_type=None,
                    failure_effect="The target has the Poisoned condition until the start of the insect's next turn.",
                ),
            ],
            reactions=[],
            legendary_actions=[],
...
class GiantLizard(ExtendedCombatantData):
    def __init__(self):
        super().__init__(
            ...
            languages="None",
            traits=[
                SpiderClimb(creature_name="lizard"),
            ],
            actions=[
                MeleeAttack(
                    name="Bite",
...
class GiantSeahorse(ExtendedCombatantData):
    def __init__(self):
        super().__init__(
            ...
            languages="None",
            traits=[
                WaterBreathing(creature_name="seahorse"),
            ],
            actions=[
                MonsterAbility(
                    name="Ram",
...
class GiantWolfSpider(ExtendedCombatantData):
    def __init__(self):
        super().__init__(
            ...
            languages="None",
            traits=[
                SpiderClimb(creature_name="spider"),
            ],
            actions=[
                MeleeAttack(
                    name="Bite",
        ...
        super().__init__(
            ...
            actions=[
                MeleeAttack(
                    ...
                    damage_bonus=1,
                    damage_type=DamageType.ACID,
                    additional_ruling="Nonmagical armor worn by the target takes a -1 penalty to the AC it offers. The armor is destroyed if the penalty reduces its AC to 10. The penalty can be removed by casting the Mending spell on the armor.",
                ),
            ],
            bonus_actions=[],
            reactions=[],
...
class HobgoblinWarrior(ExtendedCombatantData):
    def __init__(self):
        super().__init__(
            ...
            languages="Common, Goblin",
            traits=[
                PackTactics(creature_name="hobgoblin"),
            ],
            actions=[
                MeleeAttack(
                    name="Longsword",
...
class Hyena(ExtendedCombatantData):
    def __init__(self):
        super().__init__(
            ...
            languages="None",
            traits=[
                PackTactics(creature_name="hyena"),
            ],
            actions=[
                MeleeAttack(
                    name="Bite",
...
class Jackalwere(ExtendedCombatantData):
    def __init__(self):
        super().__init__(
            ...
            languages="Common",
            traits=[
                PackTactics(creature_name="jackalwere"),
            ],
            actions=[
                Multiattack(
                    creature_name="jackalwere", attacks_text="two Rend or Slam attacks"
                ),
                MeleeAttack(
                ...
                SavingThrowEffect(
                    ...
                    dc=10,
                    target="one creature the jackalwere can see within 30 feet (Constructs and Undead succeed automatically)",
                    dice_count=0,
                    damage_type=None,
                    failure_effect="The target has the Unconscious condition for 10 minutes or until it takes damage or a creature within 5 feet of it takes an action to wake it.",
                    success_effect="The target is immune to this jackalwere's Sleep Gaze for 24 hours.",
                ),
            ],
            bonus_actions=[
                MonsterAbility(
        ...
        super().__init__(
            ...
            actions=[
                MeleeOrRangedAttack(
                    ...
                    additional_ruling="Hit or Miss: The blade magically returns to the kenku's hand immediately after a ranged attack.",
                ),
            ],
            bonus_actions=[
                MonsterAbility(
...
class Kuotoa(ExtendedCombatantData):
    def __init__(self):
        super().__init__(
            ...
            traits=[
                Amphibious(creature_name="kuo-toa"),
                SunlightSensitivity(creature_name="kuo-toa"),
            ],
            actions=[
                MeleeOrRangedAttack(
                    name="Spear",
                ...
                SavingThrowEffect(
                    ...
                    ability=Ability.DEXTERITY,
                    dc=10,
                    target="one Large or smaller creature the kuo-toa can see within 15 feet",
                    dice_count=0,
                    damage_type=None,
                    failure_effect="The target has the Restrained condition until the net is destroyed (AC 10; HP 5; Immunity to Bludgeoning, Poison, and Psychic damage). A creature can take an action to make a DC 10 Strength (Athletics) check to free itself or another creature in a net within 5 feet, destroying the net on a success.",
                ),
            ],
            bonus_actions=[],
            reactions=[
        ...
        super().__init__(
            ...
            actions=[
                MeleeAttack(
                    ...
                    damage_bonus=2,
                    damage_type=DamageType.FIRE,
                    additional_ruling="If the target is a creature or a flammable object that isn't being worn or carried, it starts burning.",
                ),
            ],
            bonus_actions=[
                MonsterAbility(
        ...
        super().__init__(
            ...
            actions=[
                MeleeAttack(
                    ...
                    damage_bonus=1,
                    damage_type=DamageType.PIERCING,
                    additional_ruling="If the target is a Medium or smaller creature, it has the Prone condition.",
                ),
            ],
            bonus_actions=[],
            reactions=[],
...
class MerfolkSkirmisher(ExtendedCombatantData):
    def __init__(self):
        super().__init__(
            ...
            traits=[
                Amphibious(creature_name="merfolk"),
            ],
            actions=[
                MonsterAbility(
                    name="Ocean Spear",
        ...
        super().__init__(
            ...
            actions=[
                ...
                SavingThrowEffect(
                    ...
                    ability=Ability.DEXTERITY,
                    dc=11,
                    target="one creature the mephit can see within 15 feet",
                    dice_count=0,
                    damage_type=None,
                    failure_effect="The target has the Restrained condition until the end of the mephit's next turn.",
                ),
            ],
            bonus_actions=[],
            reactions=[],
        ...
        super().__init__(
            ...
            actions=[
                ...
                SavingThrowEffect(
                    ...
                    ability=Ability.CONSTITUTION,
                    dc=11,
                    target="one creature the myconid can see within 10 feet",
                    dice_count=0,
                    damage_type=None,
                    failure_effect="The target has the Stunned condition and repeats the save at the end of each of its turns, ending the effect on itself on a success. After 1 minute, it succeeds automatically.",
                ),
                MonsterAbility(
                    name="Rapport Spores",
    ...
    def __init__(self):
        super().__init__(
            ...
            traits=[
                ...
                WaterBreathing(creature_name="octopus"),
            ],
            actions=[
                MonsterAbility(
                    name="Tentacles",
...
class OtherworldlySteed(ExtendedCombatantData):
    def __init__(self):
        super().__init__(
            ...
            cr="0",
            monster_type=None,
            monster_type_note="Celestial or Fey or Fiend (Your Choice)",
            alignment=Alignment.NEUTRAL,
            size=Size.LARGE,
            ac_note="",
            hp_formula="",
            ...
            bonus_actions=[
                SavingThrowEffect(
                    ...
                    ability=Ability.WISDOM,
                    dc="equals your spell save DC",
                    target="one creature within 60 feet the steed can see",
                    dice_count=0,
                    damage_type=None,
                    failure_effect="The target has the Frightened condition until the end of your next turn.",
                ),
                MonsterAbility(
...
class Panther(ExtendedCombatantData):
    def __init__(self):
        super().__init__(
            ...
            bonus_actions=[
                NimbleEscape(creature_name="panther"),
            ],
            reactions=[],
            legendary_actions=[],
            legendary_resistances=0,
...
class Piercer(ExtendedCombatantData):
    def __init__(self):
        super().__init__(
            ...
            languages="None",
            traits=[
                SpiderClimb(creature_name="piercer"),
            ],
            actions=[
                MeleeAttack(
                    name="Bite",
...
class Piranha(ExtendedCombatantData):
    def __init__(self):
        super().__init__(
            ...
            languages="None",
            traits=[
                WaterBreathing(creature_name="piranha"),
            ],
            actions=[
                MonsterAbility(
                    name="Bite",
...
class Pixie(ExtendedCombatantData):
    def __init__(self):
        super().__init__(
            ...
            languages="Sylvan",
            traits=[
                MagicResistance(creature_name="pixie"),
            ],
            actions=[
                MonsterAbility(
                    name="Faerie Dust",
...
class Pseudodragon(ExtendedCombatantData):
    def __init__(self):
        super().__init__(
            ...
            traits=[
                MagicResistance(creature_name="pseudodragon"),
            ],
            actions=[
                Multiattack(
                    creature_name="pseudodragon", attacks_text="two Bite attacks"
                ),
                MeleeAttack(
                    name="Bite",
                    attack_bonus=4,
                ...
                SavingThrowEffect(
                    ...
                    ability=Ability.CONSTITUTION,
                    dc=12,
                    target="one creature the pseudodragon can see within 5 feet",
                    dice_count=2,
                    dice_type=DiceType.D4,
                    damage_bonus=0,
                    damage_type=DamageType.POISON,
                    failure_effect="and the target has the Poisoned condition for 1 hour. While Poisoned, the target also has the Unconscious condition, which ends early if the target takes damage or a creature within 5 feet of it takes an action to wake it",
                ),
            ],
            bonus_actions=[],
            reactions=[],
...
class ReefShark(ExtendedCombatantData):
    def __init__(self):
        super().__init__(
            ...
            languages="None",
            traits=[
                PackTactics(creature_name="shark"),
                WaterBreathing(creature_name="shark"),
            ],
            actions=[
                MeleeAttack(
                    name="Bite",
...
class RustMonster(ExtendedCombatantData):
    def __init__(self):
        super().__init__(
            ...
            actions=[
                Multiattack(
                    creature_name="rust monster",
                    attacks_text="one Bite attack and uses Antennae twice",
                ),
                MeleeAttack(
                    name="Bite",
                    attack_bonus=3,
...
class SahuaginWarrior(ExtendedCombatantData):
    def __init__(self):
        super().__init__(
            ...
            actions=[
                Multiattack(creature_name="sahuagin", attacks_text="two Claw attacks"),
                MeleeAttack(
                    name="Claw",
                    attack_bonus=3,
                    reach_ft=5,
...
class Satyr(ExtendedCombatantData):
    def __init__(self):
        super().__init__(
            ...
            traits=[
                MagicResistance(creature_name="satyr"),
            ],
            actions=[
                MeleeAttack(
                    name="Hooves",
                    ...
                    damage_bonus=3,
                    damage_type=DamageType.BLUDGEONING,
                    additional_ruling="If the target is a Medium or smaller creature, the satyr pushes the target up to 10 feet straight away from itself.",
                ),
                SavingThrowEffect(
                    name="Mockery",
                    ability=Ability.WISDOM,
                    dc=12,
                    target="one creature the satyr can see within 90 feet",
                    dice_count=1,
                    dice_type=DiceType.D6,
                    damage_bonus=2,
    ...
    def __init__(self):
        super().__init__(
            ...
            actions=[
                Multiattack(
                    creature_name="scout",
                    attacks_text="two attacks, using Shortsword and Longbow in any combination",
                ),
                MeleeAttack(
                    name="Shortsword",
                    attack_bonus=4,
...
class SlaadTadpole(ExtendedCombatantData):
    def __init__(self):
        super().__init__(
            ...
            traits=[
                MagicResistance(creature_name="slaad"),
            ],
            actions=[
                MeleeAttack(
                    name="Bite",
...
class Spider(ExtendedCombatantData):
    def __init__(self):
        super().__init__(
            ...
            traits=[
                SpiderClimb(creature_name="spider"),
                WebWalker(creature_name="spider", knows_location=True),
            ],
            actions=[
                MonsterAbility(
                    name="Bite",
        ...
        super().__init__(
            ...
            actions=[
                ...
                SavingThrowEffect(
                    ...
                    dc=10,
                    target="one creature within 5 feet the sprite can see (Celestials, Fiends, and Undead automatically fail the save)",
                    dice_count=0,
                    damage_type=None,
                    failure_effect="The sprite knows the target's emotions and alignment.",
                ),
                MonsterAbility(
                    name="Invisibility",
        ...
        super().__init__(
            ...
            actions=[
                ...
                SavingThrowEffect(
                    ...
                    dice_type=DiceType.D4,
                    damage_type=DamageType.FIRE,
                    failure_effect="and the target's Speed decreases by 10 feet until the end of the mephit's next turn",
    ...
    def __init__(self):
        super().__init__(
            ...
            traits=[
                ...
                TinySwarm(creature_type="insect"),
            ],
            actions=[
                MonsterAbility(
                    name="Bites",
        ...
        super().__init__(
            ...
            actions=[
                ...
                SavingThrowEffect(
                    ...
                    dice_count=0,
                    damage_type=None,
                    failure_effect="The target has the Deafened condition until the start of the swarm's next turn. While Deafened, the target also has Disadvantage on ability checks and attack rolls.",
                ),
            ],
            bonus_actions=[],
            reactions=[],
...
class Tough(ExtendedCombatantData):
    def __init__(self):
        super().__init__(
            ...
            languages="Common",
            traits=[
                PackTactics(creature_name="tough"),
            ],
            actions=[
                MeleeAttack(
                    name="Mace",
        ...
        super().__init__(
            ...
            traits=[
                SavingThrowEffect(
                    ...
                    ability=Ability.CONSTITUTION,
                    dc=12,
                    target="any creature (other than a troglodyte) that starts its turn in a 5-foot Emanation originating from the troglodyte",
                    dice_count=0,
                    damage_type=None,
                    failure_effect="The target has the Poisoned condition until the start of its next turn.",
                    success_effect="The target is immune to the Stench of all troglodytes for 1 hour.",
                ),
                SunlightSensitivity(creature_name="troglodyte"),
            ],
            actions=[
                MeleeAttack(
                    name="Rend",
...
class TwigBlight(ExtendedCombatantData):
    def __init__(self):
        super().__init__(
            ...
            languages="Understands Common but can't speak",
            traits=[
                PackTactics(creature_name="blight"),
            ],
            actions=[
                MeleeAttack(
                    name="Claw",
        ...
        super().__init__(
            ...
            traits=[
                SavingThrowEffect(
                    ...
                    ability=Ability.CONSTITUTION,
                    dc="equals your spell save DC",
                    target="any creature (other than you) that starts its turn within a 5-foot Emanation originating from the spirit",
                    dice_count=0,
                    damage_type=None,
                    failure_effect="The creature has the Poisoned condition until the start of its next turn.",
                ),
                MonsterAbility(
...
class VioletFungus(ExtendedCombatantData):
    def __init__(self):
        super().__init__(
            ...
            actions=[
                Multiattack(
                    creature_name="fungus", attacks_text="two Rotting Touch attacks"
                ),
                MeleeAttack(
                    name="Rotting Touch",
                    attack_bonus=2,
...
class Vulture(ExtendedCombatantData):
    def __init__(self):
        super().__init__(
            ...
            languages="None",
            traits=[
                PackTactics(creature_name="vulture"),
            ],
            actions=[
                MeleeAttack(
                    name="Beak",
        ...
        super().__init__(
            ...
            actions=[
                MeleeAttack(
                    ...
                    damage_bonus=4,
                    damage_type=DamageType.BLUDGEONING,
                    additional_ruling="If the horse moved at least 20 feet straight toward the target immediately before the hit, the target takes an extra 5 (2d4) Bludgeoning damage and, if it is Huge or smaller, has the Prone condition.",
                ),
            ],
            bonus_actions=[],
            reactions=[],
        ...
        super().__init__(
            ...
            actions=[
                MeleeAttack(
                    ...
                    damage_bonus=4,
                    damage_type=DamageType.BLUDGEONING,
                    additional_ruling="If the target is a Large or smaller creature and the skeleton moved 20+ feet straight toward it immediately before the hit, the target has the Prone condition.",
                ),
            ],
            bonus_actions=[],
            reactions=[],
...
class WarriorInfantry(ExtendedCombatantData):
    def __init__(self):
        super().__init__(
            ...
            languages="Common",
            traits=[
                PackTactics(creature_name="warrior"),
            ],
            actions=[
                MeleeOrRangedAttack(
                    name="Spear",
