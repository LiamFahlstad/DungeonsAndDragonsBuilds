        ...
        super().__init__(
            ...
            actions=[
                DcMonsterAbility(
                    ...
                    description="Wisdom Save (DC 11): 11 (4d4+1) on failed. The Accursed is Prone after.",
                ),
                MeleeAttack(
                    name="Feeble Grasp",
                    attack_bonus=2,
