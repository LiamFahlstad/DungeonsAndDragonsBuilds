...
class SharedResilience(Feature):
    def __init__(self):
        super().__init__(name="Shared Resilience", origin="Banneret Fighter Level 15", activation=FeatureActivation(action_type="reaction", range="60 Feet"), usage_tags=["buff"])
