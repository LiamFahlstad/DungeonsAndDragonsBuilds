...
class KnowYourEnemy(Feature):
    def __init__(self):
        super().__init__(name="Know Your Enemy", origin="Battle Master Fighter Level 7", activation=FeatureActivation(action_type="bonus_action", range="30 Feet"), usage_tags=["utility"])
