...
class LandsAid(Feature):
    def __init__(self):
        super().__init__(name="Land's Aid", origin="Circle of the Land Druid Level 3", action_type="action", range="60 Feet (10-Foot-Radius Sphere)", usage_tags=["damage", "heal"])
...
class NaturesSanctuary(Feature):
    def __init__(self):
        super().__init__(
            name="Nature's Sanctuary", origin="Circle of the Land Druid Level 14", action_type="action", duration="1 Minute or Until Incapacitated", range="120 Feet (15-Foot Cube)", usage_tags=["buff"]
        )
