...
class ShadowStep(Feature):
    def __init__(self):
        super().__init__(name="Shadow Step", origin="Warrior of Shadow Monk Level 6", activation=FeatureActivation(action_type="bonus_action", range="60 Feet"), usage_tags=["buff"])
...
class CloakOfShadows(Feature):
    def __init__(self):
        super().__init__(
            name="Cloak of Shadows", origin="Warrior of Shadow Monk Level 17", activation=FeatureActivation(action_type="action", duration="1 Minute or Until Incapacitated or Bright Light"), usage_tags=["buff"]
        )
