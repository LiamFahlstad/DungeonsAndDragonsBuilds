...
class Bloodthirst(Feature):
    def __init__(self):
        super().__init__(
            name="Bloodthirst",
            origin="Scion of the Three Rogue Level 3",
    ...
    def get_table_description(
        ...
        return [
            (
                "Trigger",
                "Enemy within 30 feet takes damage and becomes Bloodied (not killed)",
            ),
            ("Action", "Reaction"),
...
class StrikeFear(Feature):
    def __init__(self):
        super().__init__(
            name="Strike Fear",
            origin="Scion of the Three Rogue Level 9",
    ...
    def get_table_description(
        ...
        return [
            ...
            (
                "Effect",
                "Frightened for 1 minute; you have Advantage on attacks against target",
            ),
...
class AuraOfMalevolence(Feature):
    def __init__(self):
        super().__init__(
            ...
            origin="Scion of the Three Rogue Level 13",
...
class DreadIncarnate(Feature):
    def __init__(self):
        super().__init__(
            ...
            origin="Scion of the Three Rogue Level 17",
            usage_tags=["damage"],
        )
    ...
    def get_table_description(
        ...
        return [
            ...
            (
                "Murderous Intent",
                "On Sneak Attack damage, treat 1 or 2 rolled on die as 3",
            ),
        ]
