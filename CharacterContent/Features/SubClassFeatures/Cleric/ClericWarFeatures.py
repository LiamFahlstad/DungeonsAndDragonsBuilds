...
class WarPriest(Feature):
    def __init__(self):
        super().__init__(name="War Priest", origin="War Domain Cleric Level 3", action_type="bonus_action")
...
class WarGodsBlessing(Feature):
    def __init__(self):
        super().__init__(name="War God's Blessing", origin="War Domain Cleric Level 6", duration="1 Minute")
