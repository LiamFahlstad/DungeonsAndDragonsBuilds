...
class PsychicBlades(Feature):
    def __init__(self):
        super().__init__(name="Psychic Blades", origin="College of Whispers Bard Level 3")
...
class MantleOfWhispers(Feature):
    def __init__(self):
        super().__init__(name="Mantle of Whispers", origin="College of Whispers Bard Level 6")
...
class ShadowLore(Feature):
    def __init__(self):
        super().__init__(name="Shadow Lore", origin="College of Whispers Bard Level 14")
