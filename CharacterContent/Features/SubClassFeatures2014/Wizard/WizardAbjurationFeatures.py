...
class ArcaneWard(Feature):
    def __init__(self):
        super().__init__(
            name="Arcane Ward",
            origin="Abjuration Wizard Level 3",
            activation=FeatureActivation(duration="Until Long Rest"),
            usage_tags=["buff"],
        )
    ...
    def get_table_description(
        ...
        return [
            ...
            (
                "Protection",
                "Ward absorbs all damage until 0 HP, then you take remaining",
            ),
            (
                "Recharge",
                "Regains HP equal to 2 × spell level when you cast abjuration spell",
            ),
...
class ProjectedWard(Feature):
    def __init__(self):
        super().__init__(
            name="Projected Ward",
            origin="Abjuration Wizard Level 6",
...
class ImprovedAbjuration(Feature):
    def __init__(self):
        super().__init__(
            name="Improved Abjuration", origin="Abjuration Wizard Level 10"
        )
...
class SpellResistance(Feature):
    def __init__(self):
        super().__init__(
            ...
            origin="Abjuration Wizard Level 14",
            usage_tags=["buff"],
        )
