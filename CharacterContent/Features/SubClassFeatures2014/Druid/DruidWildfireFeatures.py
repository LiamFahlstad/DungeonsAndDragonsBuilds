...
class EnhancedBond(Feature):
    def __init__(self):
        super().__init__(
            name="Enhanced Bond",
            origin="Circle of Wildfire Druid Level 6",
            usage_tags=["buff"],
        )
...
class CauterizingFlames(Feature):
    def __init__(self):
        super().__init__(
            ...
            origin="Circle of Wildfire Druid Level 10",
            usage_tags=["heal", "damage"],
            activation=FeatureActivation(
                action_type="reaction", duration="1 Minute", range="30 Feet"
            ),
        )
    ...
    def get_table_description(
        ...
        return [
            (
                "Trigger",
                "Small or larger creature dies within 30 feet of you or spirit",
            ),
...
class BlazingRevival(Feature):
    def __init__(self):
        super().__init__(
            ...
            origin="Circle of Wildfire Druid Level 14",
            usage_tags=["heal"],
    ...
    def get_table_description(
        ...
        return [
            ...
            (
                "Effect",
                "Spirit drops to 0 HP; you regain half your max HP and stand up",
            ),
            ("Regain", "Long rest"),
        ]
