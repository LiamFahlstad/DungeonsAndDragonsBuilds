...
class TelepathicSpeech(Feature):
    def __init__(self):
        super().__init__(name="Telepathic Speech", origin="Aberrant Mind Sorcerer Level 3")
...
class RevelationInFlesh(Feature):
    def __init__(self):
        super().__init__(name="Revelation in Flesh", origin="Aberrant Mind Sorcerer Level 14")
...
class WarpingImplosion(Feature):
    def __init__(self):
        super().__init__(name="Warping Implosion", origin="Aberrant Mind Sorcerer Level 18")
