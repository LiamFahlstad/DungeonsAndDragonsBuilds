...
class HuntersPrey(Feature):
    def __init__(self):
        super().__init__(
            name="Hunter's Prey", origin="Hunter Ranger Level 3", usage_tags=["damage"]
        )
...
class Volley(Feature):
    def __init__(self):
        super().__init__(
            name="Volley",
            origin="Hunter Ranger Level 11",
            activation=FeatureActivation(
                action_type=ActionType.ACTION, range="10-Foot Radius"
            ),
            usage_tags=["damage"],
        )
...
class WhirlwindAttack(Feature):
    def __init__(self):
        super().__init__(
            ...
            origin="Hunter Ranger Level 11",
            activation=FeatureActivation(action_type=ActionType.ACTION, range="5 Feet"),
            usage_tags=["damage"],
        )
