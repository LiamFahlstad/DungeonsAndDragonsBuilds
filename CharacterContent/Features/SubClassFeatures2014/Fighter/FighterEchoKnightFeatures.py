...
class ManifestEcho(Feature):
    def __init__(self):
        super().__init__(name="Manifest Echo", origin="Echo Knight Fighter Level 3", activation=FeatureActivation(action_type="bonus_action", range="15 Feet"), usage_tags=["damage", "utility"])
...
class EchoAvatar(Feature):
    def __init__(self):
        super().__init__(name="Echo Avatar", origin="Echo Knight Fighter Level 7", activation=FeatureActivation(action_type="action", duration="Up to 10 Minutes", range="1,000 Feet"), usage_tags=["utility"])
...
class ShadowMartyr(Feature):
    def __init__(self):
        super().__init__(name="Shadow Martyr", origin="Echo Knight Fighter Level 10", activation=FeatureActivation(action_type="reaction", range="5 Feet"), usage_tags=["buff"])
...
class LegionOfOne(Feature):
    def __init__(self):
        super().__init__(name="Legion of One", origin="Echo Knight Fighter Level 18", activation=FeatureActivation(action_type="bonus_action"), usage_tags=["damage", "utility"])
