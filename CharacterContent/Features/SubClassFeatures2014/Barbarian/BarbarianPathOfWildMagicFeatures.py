...
class MagicAwareness(Feature):
    def __init__(self):
        super().__init__(name="Magic Awareness", origin="Path Of Wild Magic Barbarian Level 3", action_type="action", duration="Until the End of Your Next Turn", range="60 Feet", usage_tags=["utility"], uses=FeatureUses(max_uses=Definitions.MAX_PROFICIENCY_BONUS, regain_all_on="long rest", current_formula="Current amount: equal to your proficiency bonus."))
