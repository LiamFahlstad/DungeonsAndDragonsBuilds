...
class TouchOfDeath(Feature):
    def __init__(self):
        super().__init__(
            name="Touch of Death",
            origin="Way of the Long Death Monk Level 3",
...
class HourOfReaping(Feature):
    def __init__(self):
        super().__init__(
            ...
            origin="Way of the Long Death Monk Level 6",
...
class MasteryOfDeath(Feature):
    def __init__(self):
        super().__init__(
            ...
            origin="Way of the Long Death Monk Level 11",
            usage_tags=["heal"],
        )
...
class TouchOfTheLongDeath(Feature):
    def __init__(self):
        super().__init__(
            ...
            origin="Way of the Long Death Monk Level 17",
            activation=FeatureActivation(
                action_type=ActionType.ACTION, range="Touch (5 Feet)"
            ),
            usage_tags=["damage"],
        )
    ...
    def get_table_description(
        ...
        return [
            ...
            (
                "Damage",
                "2d10 necrotic per ki point spent (failed save); half on success",
            ),
        ]
