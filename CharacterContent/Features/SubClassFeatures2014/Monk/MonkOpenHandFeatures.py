...
class OpenHandTechnique(Feature):
    def __init__(self):
        super().__init__(
            ...
            origin="Way of the Open Hand Monk Level 3",
            activation=FeatureActivation(
                duration="Until End of Next Turn", range="15 Feet"
            ),
            usage_tags=["control"],
        )
...
class WholenessOfBody(Feature):
    def __init__(self):
        super().__init__(
            ...
            origin="Way of the Open Hand Monk Level 6",
...
class Tranquility(Feature):
    def __init__(self):
        super().__init__(
            name="Tranquility",
            origin="Way of the Open Hand Monk Level 11",
            activation=FeatureActivation(duration="Until Start of Next Long Rest"),
            usage_tags=["buff"],
        )
...
class QuiveringPalm(Feature):
    def __init__(self):
        super().__init__(
            name="Quivering Palm",
            origin="Way of the Open Hand Monk Level 17",
            activation=FeatureActivation(
                action_type=ActionType.ACTION,
                duration="Number of Days Equal to Monk Level",
            ),
            usage_tags=["damage"],
        )
