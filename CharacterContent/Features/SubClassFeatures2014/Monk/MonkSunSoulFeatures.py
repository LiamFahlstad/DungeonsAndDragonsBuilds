...
class RadiantSunBolt(Feature):
    def __init__(self):
        super().__init__(name="Radiant Sun Bolt", origin="Way of the Sun Soul Monk Level 3")
...
class SearingArcStrike(Feature):
    def __init__(self):
        super().__init__(name="Searing Arc Strike", origin="Way of the Sun Soul Monk Level 6")
...
class SearingSunburst(Feature):
    def __init__(self):
        super().__init__(name="Searing Sunburst", origin="Way of the Sun Soul Monk Level 11")
...
class SunShield(Feature):
    def __init__(self):
        super().__init__(name="Sun Shield", origin="Way of the Sun Soul Monk Level 17")
