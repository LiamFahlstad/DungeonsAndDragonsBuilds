...
class RadiantSunBolt(Feature):
    def __init__(self):
        super().__init__(name="Radiant Sun Bolt", origin="Way of the Sun Soul Monk Level 3", action_type="bonus_action", range="30 Feet", usage_tags=["damage"])
...
class SearingArcStrike(Feature):
    def __init__(self):
        super().__init__(name="Searing Arc Strike", origin="Way of the Sun Soul Monk Level 6", action_type="bonus_action", usage_tags=["damage"])
...
class SearingSunburst(Feature):
    def __init__(self):
        super().__init__(name="Searing Sunburst", origin="Way of the Sun Soul Monk Level 11", action_type="action", range="150 Feet (20-Foot-Radius Sphere)", usage_tags=["damage"])
...
class SunShield(Feature):
    def __init__(self):
        super().__init__(name="Sun Shield", origin="Way of the Sun Soul Monk Level 17", action_type="reaction", range="30 Feet", usage_tags=["damage"])
