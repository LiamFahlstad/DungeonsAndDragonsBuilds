...
from CharacterContent.Features.SubClassFeatures2014.Monk import MonkOpenHandFeatures
...
class MonkOpenHandLevel11(ClassBuilder.SubclassLevel11):
    ...
    def add_features(
        ...
        data.add_feature(MonkOpenHandFeatures.Tranquility())
        return data
...
class MonkOpenHandCustomStarterClassArgs(MonkCustomStarterClassArgs):
    def __init__(
        ...
        super().__init__(
            subclass=MonkSubclass2014.OPEN_HAND.value,
            skills=skills,
