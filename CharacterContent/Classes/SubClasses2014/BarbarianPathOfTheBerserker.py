...
from CharacterContent.Features.SubClassFeatures2014.Barbarian import BarbarianPathOfTheBerserkerFeatures
...
class BarbarianBerserkerLevel10(ClassBuilder.SubclassLevel10):
    ...
    def add_features(
        ...
        data.add_feature(BarbarianPathOfTheBerserkerFeatures.IntimidatingPresence())
        return data
...
class BarbarianBerserkerCustomStarterClassArgs(BarbarianCustomStarterClassArgs):
    def __init__(
        ...
        super().__init__(
            subclass=BarbarianSubclass2014.PATH_OF_THE_BERSERKER.value,
            skills=skills,
        )
