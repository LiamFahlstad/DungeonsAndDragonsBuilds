...
class Self-Restoration(TextFeature):
    def __init__(self):
...
class DisciplinedSurvivor(TextFeature):
    def __init__(self):
...
class ImplementsOfMercy(TextFeature):
    def __init__(self):
        super().__init__(name="Implements of Mercy", origin="Warrior of Mercy Monk Level 3")
...
class PhysiciansTouch(TextFeature):
    def __init__(self):
        super().__init__(name="Physician's Touch", origin="Warrior of Mercy Monk Level 6")
...
class FlurryOfHealingAndHarm(TextFeature):
    def __init__(self):
        super().__init__(name="Flurry of Healing and Harm", origin="Warrior of Mercy Monk Level 11")
...
class HandOfUltimateMercy(TextFeature):
    def __init__(self):
        super().__init__(name="Hand of Ultimate Mercy", origin="Warrior of Mercy Monk Level 17")
...
class ElementalAttunement(TextFeature):
    def __init__(self):
        super().__init__(name="Elemental Attunement", origin="Warrior of the Elements Monk Level 3")
...
class ManipulateElements(TextFeature):
    def __init__(self):
        super().__init__(name="Manipulate Elements", origin="Warrior of the Elements Monk Level 3")
...
class ElementalBurst(TextFeature):
    def __init__(self):
        super().__init__(name="Elemental Burst", origin="Warrior of the Elements Monk Level 6")
...
class StrideOfTheElements(TextFeature):
    def __init__(self):
        super().__init__(name="Stride of the Elements", origin="Warrior of the Elements Monk Level 11")
...
class ElementalEpitome(TextFeature):
    def __init__(self):
        super().__init__(name="Elemental Epitome", origin="Warrior of the Elements Monk Level 17")
...
class OpenHandTechnique(TextFeature):
    def __init__(self):
        super().__init__(name="Open Hand Technique", origin="Warrior of the open Hand Monk Level 3")
...
class WholenessOfBody(TextFeature):
    def __init__(self):
        super().__init__(name="Wholeness of Body", origin="Warrior of the open Hand Monk Level 6")
...
class FleetStep(TextFeature):
    def __init__(self):
        super().__init__(name="Fleet Step", origin="Warrior of the open Hand Monk Level 11")
...
class QuiveringPalm(TextFeature):
    def __init__(self):
        super().__init__(name="Quivering Palm", origin="Warrior of the open Hand Monk Level 17")
